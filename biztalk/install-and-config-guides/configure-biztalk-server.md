...
* Instalar actualizaciones acumulativas (Cu) o Feature Packs (FPs) *después* configurar BizTalk Server. Algunas actualizaciones incluidas en CUs o FPs solo los artefactos que están configurados de destino. Si instala CUs o FPs antes de ejecutar la configuración, vuelva a instalar la cu y FPs después de configurar. Esto garantiza que todos los componentes son revisados y actualizados.
