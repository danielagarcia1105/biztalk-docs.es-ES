...
4.  Compruebe que están habilitadas las opciones **TCP/IP** y **Canalizaciones con nombre**. Si están habilitadas, continúe en el paso siguiente.  
...
5.  Cierre el **Administrador de configuración**.  
