...
3. En la configuración de [!INCLUDE[bts2013r2_md](../includes/bts2013r2-md.md)]/2013, quite la configuración de las alertas de BAM.
4. Actualice a SQL Server 2016 o SQL Server 2014 SP1.
5. Configure el Correo electrónico de base de datos de SQL Server.
6. Actualice a [!INCLUDE[bts2016_md](../includes/bts2016-md.md)].
7. En la configuración de [!INCLUDE[bts2016_md](../includes/bts2016-md.md)], configure las alertas de BAM.
8. Implemente el archivo de definición guardado en el símbolo del sistema: `bm.exe update-all -DefinitionFile:YourBAMDefinition.xml`.
...
- **Error SSO en clúster**: en un entorno de clúster de tiempo de ejecución de BizTalk Server, al intentar actualizar puede recibir el mensaje de error:
  ...
  5. En el Administrador de clústeres, **conecte** el grupo de clústeres que contiene el recurso en clúster de tiempo de ejecución de BizTalk Server. Esto debería iniciar todos los recursos del grupo de clústeres.

  6. **Desconecte** la instancia en clúster de los servicios SSO empresariales. Después, vuelva a **conectarla**.

  7. **Mueva** el grupo de clústeres. Este paso debería mover el grupo de clústeres que contiene el recurso en clúster de tiempo de ejecución de BizTalk Server del primer nodo al segundo.

  8. **Desconecte** la instancia en clúster de los servicios SSO empresariales. Después, vuelva a **conectarla**.
