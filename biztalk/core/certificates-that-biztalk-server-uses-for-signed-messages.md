...
2.  Durante la ejecución de la canalización de envío el componente de canalización Descodificador de MIME/SMIME comprueba la firma digital mediante la clave pública del socio.  
  
3.  El socio recibe el mensaje de BizTalk Server. El socio usa la clave pública de BizTalk Server para comprobar la firma digital.  
