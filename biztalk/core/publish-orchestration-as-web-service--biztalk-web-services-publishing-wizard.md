...
1.  Haga clic en **iniciar**, apunte a **todos los programas**, apunte a **Microsoft BizTalk Server**y, a continuación, haga clic en **BizTalk Web Asistente para publicar servicios**.  
  
2.  En el **éste es el Asistente para publicar servicios Web de BizTalk** página, haga clic en **siguiente**.  
