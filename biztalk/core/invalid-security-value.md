...
## <a name="user-action"></a>Acción del usuario  
 Para resolver este error, asegúrese de que el campo ISA04 es del tipo de datos X12_AN y es de 10 caracteres (con o sin espacios finales) o que el campo UNB6.1 es del tipo de datos EDIFACT_AN y tenga entre 1 y 14 caracteres. Vuelva a enviar el intercambio.