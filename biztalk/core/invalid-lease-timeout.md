...
8.  En el **propiedades de transporte de WCF-NetTcP** cuadro de diálogo, haga clic en el **enlace** ficha.  
  
9. En el **configuración de la agrupación de conexiones** sección, asegúrese del **tiempo de espera de concesión (HH)** intervalo es válido. Los valores aceptados son de 0 a 23 horas, de 0 a 59 minutos y de 0 a 59 segundos.