---
title: Loans Processing Using Business Rules (ejemplo de BizTalk Server) | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
---
# <a name="loans-processing-using-business-rules-biztalk-server-sample"></a>Loans Processing Using Business Rules (ejemplo de BizTalk Server)
...
## <a name="what-this-sample-does"></a>Descripción del ejemplo  
 ...
 Basadas en hechos de varios orígenes, incluido el mensaje que se está procesando, este ejemplo establece el **IncomeStatus**, **CommitmentsStatus**, **EmploymentStatus**y  **ResidencyStatus** elementos del mensaje que se está procesando.  

## <a name="where-to-find-this-sample"></a>Ubicación del ejemplo  
 \<*Ejemplos de la ruta de acceso*\>\Business Rules\Loans Rules\ empresarial de procesamiento  
...
|                                                                           LoanProcessorBinding.xml                                                                            |                                                                                               Se usa para la instalación automatizada, como el enlace de puerto.                                                                                               |
...
2. En una ventana de comandos, desplácese a la siguiente carpeta:  
    ...
    \<*Ejemplos de la ruta de acceso*\>\Business Rules\Loans Processing using Business Rules  
...
1. Haga clic en **iniciar**, apunte a **programas**, apunte a [!INCLUDE[btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)]y, a continuación, haga clic en **compositor**.  
...
5. Cambie cualquier regla o acción de forma que dará como resultado valores diferentes para el **IncomeStatus**, **CommitmentsStatus**, **EmploymentStatus**, y  **ResidencyStatus** elementos. Asegúrese de que cambia también el valor de la parte de negación (fundamentalmente, la **Else** cláusula) de cualquier regla que desee cambiar.  
   ...
   |  Número de regla   |        Nombre de regla        |                                                                             Descripción                                                                             |
   |----------------|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
   |       1        |   Regla de estado de entrada    |                                       IF **BasicSalary** + **OtherIncome** > 0<br /><br /> A continuación, **IncomeStatus** = **válido**                                        |
   |       2        | Regla de estado de confirmación | IF **ID** == **ID (db)**<br /><br /> y<br /><br /> IF **CreditCardBalance (db)** > 500<br /><br /> A continuación, **CommitmentsStatus** =<br /><br /> "Compute Commitments" |
