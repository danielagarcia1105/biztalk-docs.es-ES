...
---
# <a name="understanding-the-service-oriented-solution"></a>Descripción del servicio de la solución orientada a servicios
...
- Contractual. La interfaz del servicio implementa el contrato entre los usuarios y el servicio.  
  ...
  Para obtener más información sobre las arquitecturas orientadas a servicios, vea "Service Interface" en [ http://go.microsoft.com/fwlink/?LinkId=46185 ](http://go.microsoft.com/fwlink/?LinkId=46185) y "Service-Oriented Integration" en [ http://go.microsoft.com/fwlink/?LinkId=46186 ](http://go.microsoft.com/fwlink/?LinkId=46186).  
...
## <a name="credit-card-reporting-at-woodgrove-bank"></a>Informes de tarjetas de crédito en Woodgrove Bank  
 La solución de arquitectura orientada a servicios es un servicio de informes de saldo de tarjetas de crédito para Woodgrove Bank. Aunque el banco es ficticio, no es el escenario, el escenario se basa en una aplicación real, que está implementada, al cliente.  
...
## <a name="business-requirements"></a>Requisitos empresariales  
 ...
 Para obtener información acerca de cómo la solución cumple estos requisitos, consulte [desarrollar una solución orientada a servicios de Service](../core/developing-a-service-oriented-solution.md).  
...
- La versión en línea reemplaza los adaptadores por código en línea que se comunica directamente con los sistemas de servidor. La versión en línea de la solución tiene la latencia más baja y el mayor rendimiento.  
  ...
  La guía de implementación proporciona instrucciones para crear e implementar todas las versiones de la solución, y también proporciona en cada versión una forma de simular la conexión a través de HIS con el sistema de transacciones pendientes. Para obtener información sobre cómo compilar e implementar la solución, vea [implementar la solución orientada a servicios](../core/deploying-the-service-oriented-solution.md).  
