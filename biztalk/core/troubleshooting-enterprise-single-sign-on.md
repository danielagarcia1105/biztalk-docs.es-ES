...
|               ¿La aplicación afiliada específica parece correcta?<br /><br /> ¿Qué cuentas utiliza esta aplicación afiliada?                |                                                                                               Usar la línea de comandos **ssomanage-displayapp**<em>\<nombre de la aplicación\></em>. Para obtener más información sobre este comando, consulte [cómo enumerar las propiedades de una aplicación afiliada](../core/how-to-list-the-properties-of-an-affiliate-application.md).                                                                                                |
|                                               ¿Existe alguna asignación para esta aplicación afiliada?                                               |                                                                                                                           Usar la línea de comandos **ssomanage-listmappings**<em>\<nombre de la aplicación\></em>. Para obtener más información sobre este comando, consulte [cómo Listar asignaciones de usuarios](../core/how-to-list-user-mappings.md).                                                                                                                            |
...
##### <a name="problem"></a>Problema  
 Cuando un usuario ejecuta un comando como **ssomanage - displayapp**<em>\<applicationname\></em>, donde el equipo intenta conectarse a un servidor de SSO remoto para recuperar la información, recibe el siguiente error: ERROR: 0x800706BA: el servidor RPC no está disponible.  
...
1.  Haga una copia de seguridad del secreto principal. Para obtener más información, consulte [cómo volver seguridad del secreto principal](../core/how-to-back-up-the-master-secret.md).  
