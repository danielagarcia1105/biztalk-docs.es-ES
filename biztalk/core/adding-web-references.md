...
- Una asignación de referencias (Reference.map).  
  ...
  Agregar una referencia Web al proyecto mediante el **Agregar referencia Web** cuadro de diálogo. Para obtener más información acerca de cómo agregar referencias Web, consulte [con Visual Studio](../core/using-visual-studio.md).  
