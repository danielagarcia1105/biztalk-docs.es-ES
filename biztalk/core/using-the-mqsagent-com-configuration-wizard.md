...
---
# <a name="using-the-mqsagent-com-configuration-wizard"></a>Mediante el Asistente para la configuración de MQSAgent COM +
...
> 
> [!NOTE]
>  MQSeries Agent y el ejecutable de Asistente de configuración de MQSAgent COM + **MQSConfigWiz.exe** no se instalan si actualiza desde BizTalk Server 2009 a BizTalk Server. Después de actualizar a BizTalk Server de BizTalk Server 2009 vuelva a ejecutar el programa de instalación, seleccione el **modificar** opción y seleccione MQSeries Agent en Software adicional para instalar estos componentes.  

## <a name="to-set-the-application-identity"></a>Para definir la identidad de la aplicación  

-   Use la **identidad de aplicación** página del Asistente configuración de MQSAgent COM + para establecer la identidad de aplicación de MQSAgent, como se indica a continuación:  
...
- Use la **nombre de la función** página MQSAgent COM + configuración de asignar un nombre y los usuarios a la función como sigue:  
...
6.  En el **Mi PC** cuadro de diálogo, haga clic en el **MSDTC** pestaña y, a continuación, haga clic en **configuración de seguridad**.  

7.  En el **configuración de seguridad** cuadro de diálogo el **comunicación del Administrador de transacciones** sección, seleccione **No se requiere autenticación**. Si aparece un cuadro de diálogo, haga clic en **Sí** para reiniciar la Service DTC MS.  
...
1.  Habilite los cambios para el componente MQSAgent COM+.  
    ...
    -   Haga clic en **iniciar** y, a continuación, haga clic en **Panel de Control**.  
...
2.  Cree una nueva aplicación COM+ para los componentes de tiempo de ejecución de MQSAgent.  
    ...
    -   Haga clic en **aplicaciones COM +**, haga clic en **New**, **aplicación** para mostrar el **Asistente para instalación de aplicación COM +** y haga clic en  **Siguiente**.  
    ...
    -   Seleccione la opción de **este usuario**, escriba la información de la cuenta adecuada y haga clic en **siguiente**.  
    ...
    -   Haga clic en **siguiente** en el **agregar Roles de aplicación** cuadro de diálogo.  

    -   Haga clic en **siguiente** en el **agregar usuarios a Roles** cuadro de diálogo.  
...
3.  Mueva los componentes de ejecución a la nueva aplicación COM+  
    ...
    -   Haga clic en el **MQSAgent2.MQSAgent.1** componente y haga clic en **mover** para mostrar el **mover componentes (s)** cuadro de diálogo.  
