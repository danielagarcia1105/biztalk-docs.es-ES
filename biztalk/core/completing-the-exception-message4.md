...
-   Para completar el flujo de la excepción, agregue un **enviar** forma para redirigir el mensaje de error Message_3 a una carpeta supervisada.  
  
## <a name="see-also"></a>Vea también  
 [Cómo agregar un bloque de excepción de filtrado](../core/how-to-add-a-catch-exception-block2.md)   
