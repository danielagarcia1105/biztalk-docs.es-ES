...
1.  Instale y configure [!INCLUDE[prague](../includes/prague-md.md)] en una máquina virtual. Asegúrese de usar las opciones de instalación y configuración predeterminadas, porque Sysprep no es compatible con la instalación personalizada.  
