...
|**InboundNodeEncoding**|Enum<br /><br /> -   **Base64** -codificación Base64.<br />-   **Hex** : Hexadecimal codificación.<br />-   **Cadena** : codificación de texto - UTF-8.<br />-   **XML** -los adaptadores WCF crean el cuerpo del mensaje de BizTalk con el XML externo del nodo seleccionado por la expresión de ruta de acceso de cuerpo en **InboundBodyPathExpression**.|Especifique el tipo de codificación que WCF-CustomIsolated adaptador de recepción utiliza para descodificar el nodo identificado por la expresión de ruta de acceso de cuerpo especificada en **InboundBodyPathExpression**. Esta propiedad es necesaria si la **InboundBodyLocation** propiedad está establecida en **UseBodyPath**.<br /><br /> Valor predeterminado: **XML**|  
...
1.  Si planea usar los puntos de extensibilidad WCF, tales como los elementos de enlace personalizados, el elemento de comportamiento personalizado y los componentes de canal personalizados a la hora de configurar el adaptador de WCF-CustomIsolated, debe agregar los ensamblados que implementan los puntos de extensibilidad, así como todos los ensamblados dependientes de la caché de ensamblados global, en el equipo de procesamiento de BizTalk (equipo en tiempo de ejecución) y en el equipo de administración. Además, debe registrar los componentes de extensión en el archivo machine.config. Para obtener más información acerca de cómo utilizar los puntos de extensibilidad WCF con el adaptador de WCF CustomIsolated, vea [cómo habilitar los puntos de extensibilidad de WCF con los adaptadores de WCF](../core/how-to-enable-the-wcf-extensibility-points-with-the-wcf-adapters.md).  
  
2.  En la consola de administración de BizTalk, expanda  **[!INCLUDE[prague](../includes/prague-md.md)] administración**, expanda **grupo de BizTalk**, expanda **aplicaciones**y, a continuación, expanda la aplicación en el que desea crear una ubicación de recepción.  
...
5.  En el **propiedades de la ubicación de recepción** cuadro de diálogo la **transporte** junto a la sección **tipo**, seleccione **WCF-CustomIsolated** desde el lista desplegable y, a continuación, haga clic en **configurar**.  
  
6.  En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **General** pestaña, configure la dirección del extremo y ubicación de recepción de la identidad del servicio de WCF-CustomIsolated. Para obtener más información sobre la **General** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea la **cuadro diálogo de propiedades de transporte WCF-Custom, recepción, General** ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
7.  En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **enlace** pestaña, configure distintos tipos de enlaces predefinidos o personalizados de WCF. Para obtener más información sobre la **enlace** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea el **enlace de cuadro de diálogo de propiedades de transporte WCF-Custom, recepción,** ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
8.  En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **comportamiento** pestaña, configure el punto de conexión y comportamientos de servicio para esta ubicación de recepción. Un comportamiento de extremo consiste en un conjunto de elementos de extensión de comportamiento que modifican o amplían el servicio o la funcionalidad del cliente. Para obtener más información sobre la **comportamiento** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea el **delcuadrodediálogodepropiedadesdetransporteWCF-Custom,recepción,comportamiento** ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
9. En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **otros** pestaña, configure qué credenciales para esta ubicación de recepción para utilizar al sondear un servicio externo y si esta recepción ubicación conserva el orden de los mensajes al procesar mensajes. Para obtener más información sobre la **otros** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea la **cuadro diálogo de propiedades de transporte WCF-Custom, recepción, otros**ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
10. En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **mensajes** ficha, especifique la selección de datos de SOAP **cuerpo** elemento. Para obtener más información sobre la **mensajes** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea el **delcuadrodediálogodepropiedadesdetransporteWCF-Custom,recepción,mensajes** ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
11. En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo la **importación/exportación** ficha, importar y exportar la **dirección (URI)** y **extremo Identidad** propiedades en el **General** ficha, información de enlace de la **enlace** pestaña y el comportamiento de punto de conexión en el **comportamiento** pestaña Esta ubicación de recepción. Para obtener más información sobre la **importación/exportación** pestaña en el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, vea la **cuadro de diálogo de propiedades de transporte de WCF-Custom, recepción, Importación y exportación** ficha [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
