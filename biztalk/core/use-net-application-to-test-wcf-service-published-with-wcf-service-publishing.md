...
1.  Abra el Shell CMD como sigue: haga clic en **iniciar**, apunte a **todos los programas**, apunte a **Microsoft Windows SDK**y, a continuación, haga clic en **Shell de CMD**.  
