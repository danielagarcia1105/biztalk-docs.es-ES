...
---
# <a name="single-sign-on-event-10566"></a>Inicio de sesión único: Evento 10566
...
|Texto del mensaje|No se pueden actualizar algunos de los marcadores especificados para la aplicación. Se ignorarán.%r<br /><br /> Nombre de la aplicación: %1 %r<br /><br /> Especifica la máscara de indicador: %2|  
