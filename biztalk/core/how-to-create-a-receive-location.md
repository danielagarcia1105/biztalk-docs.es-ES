---
title: Cómo crear una ubicación de recepción | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
3. Haga clic en **ubicaciones de recepción**, apunte a **New**y, a continuación, haga clic en **ubicación de recepción unidireccional** o **solicitar ubicación de recepción**, de acuerdo con el tipo de ubicación de recepción para crear.  
...
5. En el **propiedades de ubicación de recepción** , realice lo siguiente y, a continuación, haga clic en **Aceptar**:  
   ...
   |**Configurar**|Después de seleccionar el tipo de transporte, haga clic en **configurar** para mostrar el **propiedades de transporte** diálogo cuadro y configure las propiedades de adaptador para la ubicación de recepción. Para obtener instrucciones, haga clic en **ayuda** en el cuadro de diálogo. Para obtener detalles sobre la configuración de cada tipo de adaptador, vea el tema correspondiente en [utilizando adaptadores](../core/using-adapters.md).|  
   ...
   |**Canalización de recepción**|Seleccionar la canalización de recepción para recibir mensajes en esta ubicación de recepción en la lista desplegable.|  
