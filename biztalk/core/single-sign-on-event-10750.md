...
---
# <a name="single-sign-on-event-10750"></a>Inicio de sesión único: Evento 10750
...
|Texto del mensaje|PasswordChangeNotify: Tipo de nombre de usuario incorrecto. El único valor aceptado es USER_NAME_TYPE_NT4.<br /><br /> La configuración del destino es incorrecta en Active Directory.%r<br /><br /> Tipo de nombre de usuario: %1 %r<br /><br /> El usuario cliente: %2 %r<br /><br /> Código de error: %3|  
