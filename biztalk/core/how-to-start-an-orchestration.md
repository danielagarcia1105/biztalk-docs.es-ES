...
-   Al iniciar una orquestación, no se inicia automáticamente todos los puertos de envío asociados. Debe iniciar por separado, tal como se describe en [cómo iniciar un puerto de envío o un grupo de puertos de envío](../core/how-to-start-a-send-port-or-send-port-group.md).  
