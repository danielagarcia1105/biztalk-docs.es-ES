...
ms.locfileid: "22233388"
---
# <a name="configuring-the-windows-sharepoint-services-adapter"></a>Configurar el adaptador de Windows SharePoint Services
En los temas de esta sección se describe cómo configurar el adaptador de Windows SharePoint Services.  
...
-   [Cómo configurar puertos de envío mediante Windows Sharepoint Services propiedades de contexto](../core/configure-send-ports-using-sharepoint-context-properties-in-biztalk-server.md)  
...
-   [Compatibilidad con 4.0 de Windows SharePoint Services](../core/windows-sharepoint-services-4-0-support.md)  
