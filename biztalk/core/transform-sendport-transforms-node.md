...
---
# <a name="transform-sendport-transforms-node"></a>Transformación (nodo puertoEnvío transformaciones)
El nodo Transformación del nodo Transformaciones de un archivo de enlace contiene información específica acerca de una asignación de BizTalk Server que se exporta con el archivo de enlace.  
