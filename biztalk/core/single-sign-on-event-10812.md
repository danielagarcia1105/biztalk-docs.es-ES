...
---
# <a name="single-sign-on-event-10812"></a>Inicio de sesión único: Evento 10812
...
|Identificador del evento|10812|  
|Origen del evento|ENTSSO|  
|Componente|N/D|  
|Nombre simbólico|ENTSSO_E_HISSO_LSA_S4U_FAILED|  
|Texto del mensaje|El servidor LSA devolvió un error.|  
