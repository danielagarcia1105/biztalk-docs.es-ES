...
2.  En la lista de adaptadores expandida, haga clic en **WCF-WSHttp**, en el panel derecho, haga el controlador de envío que desea configurar y, a continuación, haga clic en **propiedades**.  
...
4.  En el **General** ficha, haga clic en **propiedades**, en la **Proxy** ficha, realice lo siguiente.  
