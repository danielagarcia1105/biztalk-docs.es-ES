...
```  
 ...
 El **performanceCounters** atributo se puede establecer para habilitar un tipo específico de contadores de rendimiento. Los valores válidos son  
...
-   **Desactivar**: contadores de rendimiento ServiceModel * están deshabilitados. Es el valor predeterminado.  
...
## <a name="types-of-performance-counters"></a>Tipos de contadores de rendimiento  
 Contadores de rendimiento de WCF abarcan tres niveles diferentes: servicio, extremo y operación.  
...
```  
 ...
 Puesto que los adaptadores de WCF crean un host de servicio independiente para cada ubicación de recepción, se crea una instancia de contador de rendimiento para cada ubicación de recepción. Para obtener más información acerca de la clase de servicio implementa WCF contratos de servicio, consulte la **BizTalkServiceInstance (clase)** [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)]. 
  
 **Contadores de rendimiento de punto de conexión**  
...
```  
 ...
 Se crea una instancia de contador de rendimiento para cada ubicación de recepción. En el patrón anterior, el nombre del contrato de servicio de WCF representa el contrato de servicio que los adaptadores de WCF eligen para recibir los mensajes a través de la ubicación de recepción. Para obtener más información acerca de cómo los adaptadores de WCF eligen un contrato de servicio de WCF disponible contratos de servicio, consulte **referencia de contrato de servicio de adaptadores de WCF** [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].  
  
 **Contadores de rendimiento de operación**  
...
> [!NOTE]
>  Para obtener más información acerca de cómo los adaptadores de WCF eligen un contrato de servicio de WCF disponible contratos de servicio, consulte **referencia de contrato de servicio de adaptadores de WCF** [!INCLUDE[ui-guidance-developers-reference](../includes/ui-guidance-developers-reference.md)].
