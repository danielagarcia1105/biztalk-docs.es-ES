...
---
# <a name="business-process-management-solution"></a>Solución de administración de procesos empresariales
La solución Administración de procesos empresariales muestra cómo diseñar una aplicación de BizTalk para administrar un proceso empresarial como, por ejemplo, el procesamiento de pedidos de servicio. La solución demuestra cómo construir un administrador de procesos y proporciona instrucciones para dividir un proceso en distintas fases. La solución también describe cómo construir orquestaciones ininterrumpibles así como un control de excepciones amplio y sofisticado.  
...
-   [Descripción de la solución de administración de procesos empresariales](../core/understanding-the-business-process-management-solution.md)  
