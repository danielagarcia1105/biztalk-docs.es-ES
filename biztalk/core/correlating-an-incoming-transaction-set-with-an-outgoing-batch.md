---
title: Correlación de una transacción entrante establecido con un lote saliente | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
1.  Cuando el desensamblador EDI procesa un intercambio EDI entrante, crea entradas en las tablas InterchangeStatusActivity y TransactionSetActivity.  
    ...
    > [!NOTE]
    >  Para obtener más información acerca de las actividades BAM, consulte [las actividades de BAM creadas para el seguimiento de mensajes EDI / AS2](../core/bam-activities-created-to-track-edi-as2-messages.md).  
...
## <a name="see-also"></a>Vea también  
 [Actividades de BAM creadas para el seguimiento de mensajes EDI / AS2](../core/bam-activities-created-to-track-edi-as2-messages.md)   
