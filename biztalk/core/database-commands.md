 ...
 **el programa de instalación de bm.exe-databases-ConfigFile:\<archivo de configuración > [- NSUser:\<nombre de usuario del servicio de notificaciones >] [- NSUserPassword:\<contraseña de usuario del servicio de notificaciones >]**  
 ...
 **bm.exe migrar t-SQL-de: sql2000-a: sql2008 [- NSUser:\<nombre de usuario del servicio de notificaciones >] [- NSUserPassword:\<contraseña de usuario del servicio de notificaciones >] [-Server:\<servidor >] [-base de datos:\< base de datos >]**  
  
 \-O bien -  
  
 **bm.exe migrar t-SQL-de: sql2005-a: sql2008 [- NSUser:\<nombre de usuario del servicio de notificaciones >] [- NSUserPassword:\<contraseña de usuario del servicio de notificaciones >] [-Server:\<servidor >] [-base de datos:\< base de datos >]**  
 ...
 **bm.exe enable-reference - TargetServer:\<servidor de destino > - TargetDatabase:\<base de datos de destino > [-Server:\<servidor >] [-base de datos:\<base de datos >]**  
 ...
 **bm.exe get-references [-Server:\<servidor >] [-base de datos:\<base de datos >]**  
 ...
 **bm.exe disable-reference - TargetServer:\<servidor de destino > - TargetDatabase:\<base de datos de destino > [-Server:\<servidor >] [-base de datos:\<base de datos >]**  
