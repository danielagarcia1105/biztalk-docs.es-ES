...
1.  En la ventana Vista orquestación, use el **parámetros de orquestación** carpeta para agregar variables, mensajes y puertos.  
  
2.  Para cada elemento agregado a la **parámetros de orquestación** carpeta, use la ventana Propiedades para especificar el **dirección** propiedad:  
  
    -   En, se pasa un parámetro por valor.  
  
    -   Ref, se pasa un parámetro por referencia.  
  
    -   Out: pasa un parámetro fuera por referencia.  
...
-   No se puede pasar o hacen referencia a parámetros a una orquestación en un **Iniciar orquestación** forma.  
