...
1. En Microsoft [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)], en el **archivo** menú, haga clic en **New**y, a continuación, haga clic en **proyecto**.  
...
2. En el **nuevo proyecto** cuadro de diálogo, en el panel tipos de proyecto, seleccione **BizTalk (proyectos)**. En el panel Plantillas, seleccione **proyecto de importación BPEL de BizTalk (servidor)**.  

3. En el **nombre** , escriba **BPELShipping**.  
...
7. Seleccione todos los archivos desde el \< *ruta de ejemplos*\>carpeta \Orchestrations\BPELImport\BPELSource, haga clic en **abierto**y, a continuación, haga clic en **siguiente**.  
...
15. En el Explorador de soluciones, seleccione **Agregar referencia**y en el **proyectos** , haga clic **examinar**.  
...
18. En el **vista** menú, seleccione **otras orquestaciones/Windows Vista**.  
...
22. En la ventana Vista orquestación, expanda **tipos de mensajes de multiparte/tipos**.  
...
25. En el **Seleccionar tipo de artefacto** cuadro de diálogo, haga clic en **ShippingSchemas**, seleccione el **Imported_InvoiceAckMessage** escriba y, a continuación, haga clic en **Aceptar**.  
...
45. En la ventana Propiedades, haga clic en el botón de puntos suspensivos (**...** ) en **las propiedades de correlación**.  
 ...
 *\<Ejemplos de la ruta de acceso\>* \Orchestrations\BPELImport  
...
2. Desde el [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] símbolo del sistema, cambie el directorio (**cd**) a la siguiente carpeta:  
    ...
    *\<Ejemplos de la ruta de acceso\>* \Orchestrations\BPELImport\Solution\ShipperProcess  
...
1. > [!WARNING]
    ...
    *\<Ejemplos de la ruta de acceso\>* \Orchestrations\BPELImport\Solution\BPELShipping  
...
1.  Copia el **Order.xml** de archivos desde el  *\<ruta de ejemplos\>* \Orchestrations\BPELImport\Solution en la carpeta la \< *derutadeejemplos\>* Carpeta \Orchestrations\BPELImport\Solution\Ports\ReceiveOrder.  

2.  La orquestación BPELShipping elige este archivo como un pedido desde el sistema de procesamiento de pedidos de cliente, se ejecuta a través del proceso de trasvase de registros y genera un archivo cada uno de los \< *ruta de ejemplos*\>\ Carpeta Orchestrations\BPELImport\Solution\Ports\SendOrder y \< *ruta de ejemplos*\>carpeta \Orchestrations\BPELImport\Solution\Ports\FinalConfirmation. El formato del nombre de estos archivos es \< *MessageID*\>.xml, donde *\<MessageID\>* es el GUID generado para identificar de forma única el Mensaje.  
...
3. Vaya a \< *ejemplos de la ruta de acceso*\>\Orchestrations\BPELImport\ShipperProcess.  
