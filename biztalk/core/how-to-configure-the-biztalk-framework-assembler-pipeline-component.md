...
---
# <a name="how-to-configure-the-biztalk-framework-assembler-pipeline-component"></a>Cómo configurar el componente de canalización de ensamblador de BizTalk Framework
### <a name="to-configure-the-properties-for-the-biztalk-framework-assembler-pipeline-component"></a>Para configurar las propiedades del componente de canalización de ensamblador de BizTalk Framework  
