...
-   Un registro delimitado denominado "items" con el delimitador secundario (,), el prefijo de orden secundario y la etiqueta ITEMS.  
    ...
    -   Un formato delimitado, registro de repetición con el nombre de elemento con el delimitador secundario &#124; infijo de orden secundario y la etiqueta de elemento.  
