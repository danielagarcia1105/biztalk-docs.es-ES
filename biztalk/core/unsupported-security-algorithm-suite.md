...
8.  En el **propiedades de transporte de WCF-NetTcp** cuadro de diálogo, haga clic en el **seguridad** ficha.  
  
9. En el **seguridad de mensaje** sección, asegúrese de que los valores de **algorithmsuite** son correctos.