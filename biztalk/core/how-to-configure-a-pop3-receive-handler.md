...
---
# <a name="how-to-configure-a-pop3-receive-handler"></a>Cómo configurar controlador de recepción de POP3
Siga el procedimiento que se especifica a continuación para modificar el host asociado al controlador de recepción POP3.  
  
### <a name="to-configure-the-general-properties-for-a-pop3-receive-handler"></a>Para configurar las propiedades generales de un controlador de recepción POP3  
...
2.  En la lista de adaptadores expandida, haga clic en **POP3**, en el panel derecho, haga el controlador de recepción que desea configurar y, a continuación, haga clic en **propiedades**.  
