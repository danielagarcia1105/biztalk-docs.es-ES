...
## <a name="importing-the-biztalk-adapter-framework-extensions-schema-xsd"></a><span data-ttu-id="fd2f5-107">Importar el esquema XSD de extensiones del marco de trabajo de adaptadores de BizTalk</span><span class="sxs-lookup"><span data-stu-id="fd2f5-107">Importing the BizTalk Adapter Framework Extensions Schema XSD</span></span>  
 <span data-ttu-id="fd2f5-108">Importando el esquema XSD de extensiones del marco de trabajo, puede usar decoraciones como \<BAF: filename\> como un tipo de elemento, que muestra el nombre de archivo emergente cuando se edita el elemento.</span><span class="sxs-lookup"><span data-stu-id="fd2f5-108">By importing the Adapter Framework extensions schema XSD, you can use decorations such as \<baf:FileName\> as an element's type, which shows the file name pop-up when editing the element.</span></span>  
  
 <span data-ttu-id="fd2f5-109">Otras decoraciones controlan la visualización de la propiedad en la interfaz.</span><span class="sxs-lookup"><span data-stu-id="fd2f5-109">Additional decorations control the display of the property in the interface.</span></span> <span data-ttu-id="fd2f5-110">El \<BAF: Description\> decoración, por ejemplo, agrega el texto de ayuda para el elemento.</span><span class="sxs-lookup"><span data-stu-id="fd2f5-110">The \<baf:description\> decoration, for example, adds help text to the element.</span></span> <span data-ttu-id="fd2f5-111">El \<BAF: Description\> decoración muestra el texto en la parte inferior de la página de propiedades.</span><span class="sxs-lookup"><span data-stu-id="fd2f5-111">The \<baf:description\> decoration displays the text at the bottom of the property page.</span></span> <span data-ttu-id="fd2f5-112">El \<baf: browsable\> decoración oculta un elemento de la interfaz.</span><span class="sxs-lookup"><span data-stu-id="fd2f5-112">The \<baf:browsable\> decoration hides an element from the interface.</span></span> <span data-ttu-id="fd2f5-113">El siguiente código muestra cómo puede usar estos elementos dentro de un esquema de configuración:</span><span class="sxs-lookup"><span data-stu-id="fd2f5-113">The following code shows how you can use these elements within a configuration schema:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="fd2f5-114">Vea también</span><span class="sxs-lookup"><span data-stu-id="fd2f5-114">See Also</span></span>  
 [<span data-ttu-id="fd2f5-115">Extensiones de esquema de configuración del marco de trabajo de adaptadores</span><span class="sxs-lookup"><span data-stu-id="fd2f5-115">Adapter Framework Configuration Schema Extensions</span></span>](../core/adapter-framework-configuration-schema-extensions.md)