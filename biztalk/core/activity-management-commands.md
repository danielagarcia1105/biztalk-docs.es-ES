 ...
 **bm.exe get-activities [-View:\<nombre de la vista\> ] [-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
  
 **Parámetros**  
  
|Parámetro|Description|  
|---------------|-----------------|  
|Nombre:\<nombre de la actividad\>|Nombre de la actividad que se va a quitar.|  
 ...
 **bm.exe remove-activity-Name:\<nombre de la actividad\>[-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
 ...
 **bm.exe get-activitywindow-actividad:\<nombre de la actividad\>[-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
  
 **Parámetros**  
  
|Parámetro|Description|  
|---------------|-----------------|  
|Actividad:\<nombre de la actividad\>|El nombre de la .activity.|  
 ...
 **bm.exe set-activitywindow-actividad:\<nombre de la actividad\> - TimeLength:\<número entero\> - TimeUnit: mes &#124; día &#124; Hora &#124; Minuto [-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
  
 **Parámetros**  
  
|Parámetro|Description|  
|---------------|-----------------|  
|Actividad:\<nombre de la actividad\>|Nombre de la actividad.|  
 ...
 **bm.exe get-index-actividad:\<nombre de la actividad\>[-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
 ...
 **bm.exe crear-index - IndexName:\<nombre del índice\> -actividad:\<nombre de la actividad\> -punto de comprobación:\<punto de Control1\>[,\<punto de control2\>...] [-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
...
|Actividad:\<nombre de la actividad\>|Nombre de la actividad para la que se crea el índice.|  
 ...
 **bm.exe delete-index - IndexName:\<nombre del índice\> -actividad:\<nombre de la actividad\>[-Server:\<server\> ] [-base de datos:\<base de datos\> ]**  
...
|Actividad:\<nombre de la actividad\>|Nombre de la actividad para la que se elimina el índice.|  
|Servidor:\<server\>|Opcional: El nombre del servidor en el que reside la actividad. El servidor debe estar en el mismo dominio que el equipo desde el que se ejecuta bm.exe. Si no se especifica el nombre de servidor, bm.exe utiliza el nombre predeterminado de localhost.|  
|Base de datos:\<base de datos\>|Opcional: El nombre de la base de datos en el que reside la actividad. Si no se especifica el nombre, bm.exe usa el nombre predeterminado BamPrimaryImport.|  
 ...
 **bm.exe get-archivo-actividad:\<actividad\> [-Server:\<server\>] [-base de datos:\<base de datos\>]**  
  
 **Parámetros**  
  
|Parámetro|Description|  
|---------------|-----------------|  
|Actividad:\<nombre de la actividad\>|Nombre de la actividad para la que se debe mostrar el comportamiento.|  
|Servidor:\<server\>|Opcional: El nombre del servidor en el que reside la actividad. El servidor debe estar en el mismo dominio que el equipo desde el que se ejecuta bm.exe. Si no se especifica el nombre de servidor, bm.exe utiliza el nombre predeterminado de localhost.|  
|Base de datos:\<base de datos\>|Opcional: El nombre de la base de datos en el que reside la actividad. Si no se especifica el nombre, bm.exe usa el nombre predeterminado BamPrimaryImport.|  
 ...
 **bm.exe set-archivo - actividad:\<actividad\> - ShouldArchive: True [-Server:\<server\>] [-base de datos:\<base de datos\>]**  
