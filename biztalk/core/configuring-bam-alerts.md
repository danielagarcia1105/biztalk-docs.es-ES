...
2.  Vaya a la carpeta de seguimiento escribiendo en el símbolo **cd "C:\Program Files\Microsoft BizTalk Server \<versión\>\Tracking"** o **cd "C:\Program Files (x86) \Microsoft BizTalk Servidor \<versión\>\Tracking "** en un equipo de 64 bits. Presione **ENTRAR**.  
  
3.  Recupere el archivo ADF. Tipo **cscript ProcessBamNSFiles.vbs-Get \<ConfigFilePath\> \<ADFFilePath\> \< servidor PID\> \< base de datos PID \>** . Sustituya ConfigFilePath, ADFFilePath, Servidor PID y Base de datos PID con los valores apropiados para su instalación.  
...
6.  Guarde el archivo ADF. Tipo **cscript ProcessBamNSFiles.vbs-Update \<ConfigFilePath\> \<ADFFilePath\> \< servidor PID\> \< base de datos PID \>** .  
...
5. Conceder los derechos de NS para el servicio NS de base de datos conforme a [ http://go.microsoft.com/fwlink/?LinkId=62008 ](http://go.microsoft.com/fwlink/?LinkId=62008).  
