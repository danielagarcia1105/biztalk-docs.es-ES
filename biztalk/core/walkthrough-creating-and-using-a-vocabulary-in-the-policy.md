...
---
# <a name="walkthrough-creating-and-using-a-vocabulary-in-the-policy"></a>Tutorial: Crear y usar un vocabulario en la directiva
...
## <a name="prerequisites"></a>Requisitos previos  
 Debe completar el [Tutorial: crear una directiva empresarial sencilla](../core/walkthrough-creating-a-simple-business-policy.md) tutorial antes de realizar este tutorial. Sin embargo, se recomienda realizar previamente todos los tutoriales que aparecen enumerados antes de éste en la documentación.  
...
|Título del procedimiento|Descripción de procedimiento|  
|---------------------|---------------------------|  
|Para crear el vocabulario POVocabulary|Proporciona instrucciones paso a paso para crear el **POVocabulary** vocabulario con tres definiciones: cantidad solicitada, el máximo número de elementos permitidos y estado de la solicitud.|  
...
3.  Haga clic en **vocabularios**, haga clic en **Agregar nuevo vocabulario**y, a continuación, escriba **POVocabulary** como el nombre del vocabulario.  
...
7.  Para el **nombre de la definición**, tipo **cantidad solicitada**.  
  
8.  Haga clic en **examinar**y seleccione el **PO.xsd** que ha creado en [Tutorial: crear una directiva empresarial sencilla](../core/walkthrough-creating-a-simple-business-policy.md).  
...
15. Para el **nombre de la definición**, tipo **estado de la solicitud**.  
...
22. Asegúrese de que **constante de valor, rango de valores o conjunto de valores** está seleccionada y, a continuación, haga clic en **siguiente**.  
  
23. Para el **nombre de la definición**, tipo **máximo número de elementos permitidos**.  
  
24. Asegúrese de que **tipo de definición de valor constante** está seleccionada y, a continuación, haga clic en **siguiente**.  
  
25. Tipo **500** para el valor y, a continuación, haga clic en **finalizar**.  
...
6.  Seleccione la acción existente en el panel, a continuación, contextual y, a continuación, haga clic en **Eliminar acción**.  
...
1.  En el Compositor de reglas de negocio, expanda **directivas**, expanda **ProcessPurchaseOrder**, haga clic en **versión 1.0 - implementada**y, a continuación, haga clic en **anularlaimplementación**.  
...
5.  Copia el **SamplePO.xml** archivo desde el directorio C:\BRE-Walkthroughs al directorio C:\BRE-Walkthroughs\RuleTestSol\Input para la orquestación.  
  
6.  Debería ver un archivo de salida en el directorio C:\BRE-Walkthroughs\RuleTestSol\Output para la orquestación. Abra el archivo XML de salida y observe que el valor de la **estado** campo se establece en **aprobado**.  
  
7.  Repita los pasos 5 y 6 con **SamplePO2.xml**y tenga en cuenta que el valor de la **estado** campo en el documento de salida es igual que en el documento de entrada (**XYZ**).  
...
- En el procedimiento "para crear el vocabulario POVocabulary", ha cambiado el tipo de documento para **RuleTest.PO**. Para ver los resultados de este cambio, en [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)], en el Explorador de soluciones, haga clic en **PO.xsd**. En la ventana Propiedades, tenga en cuenta que **RuleTest** es el nombre del espacio de nombres, y **PO** es el nombre de la **tipo**.  
...
- Al seleccionar **realizar operación "Set"** en la segunda página del Asistente para definición de vocabulario, puede especificar un **cadena de formato de presentación** en la página siguiente. Por ejemplo, puede cambiar la cadena de formato de presentación de **estado de la solicitud {0}**  a **solicitar el estado es: {0}**  antes de hacer clic **finalizar** en el paso 20 del procedimiento "crear el vocabulario".  
  
## <a name="next-steps"></a>Pasos siguientes  
 Ahora que ha realizado este tutorial, realice el [Tutorial: agregar una regla a la directiva](../core/walkthrough-adding-a-rule-to-the-policy.md) tutorial, lo que le ofrece instrucciones paso a paso para agregar una nueva regla a la **ProcessPurchaseOrder**directiva.  
