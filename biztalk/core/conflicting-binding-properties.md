...
|Componente|0|  
|Nombre simbólico|0|  
|Texto del mensaje|En conflicto propiedades de enlace: MsmqAuthenticationMode = {0} y MsmqProtectionLevel = \ {1\\} no es válido. Cambie una de las propiedades para resolver el conflicto.|  
  
## <a name="explanation"></a>Explicación  
 La propiedad de nivel de protección de MSMQ de un transporte de WCF-NetMsmq se estableció en **inicio de sesión** o **EncryptAndSign** para el modo de autenticación de MSMQ.  
...
8.  En el **propiedades de transporte de WCF-NetMsmq** cuadro de diálogo, haga clic en el **seguridad** ficha.  
...
-   [Cómo configurar un WCF-NetMsmq ubicación de recepción](../core/how-to-configure-a-wcf-netmsmq-receive-location.md)