...
---
# <a name="single-sign-on-event-10811"></a>Inicio de sesión único: Evento 10811
...
|Identificador del evento|10811|  
|Origen del evento|ENTSSO|  
|Componente|N/D|  
|Nombre simbólico|ENTSSO_E_HISSO_LSA_INITIALIZATION_FAILED|  
|Texto del mensaje|No se pudo establecer la conexión con el servidor LSA.|  
