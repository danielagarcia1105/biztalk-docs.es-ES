...
## <a name="what-this-sample-does"></a>Descripción del ejemplo  
 Este ejemplo muestra cómo utilizar el **ExplorerOM** administrativas clases para crear y configurar puertos de recepción y ubicaciones de recepción. En este tema también se incluye un script de ejemplo de Windows PowerShell. El ejemplo realiza las siguientes operaciones:  
...
|---------------|-----------------|  
|ReceiveLocations.cs|[!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)]archivo de código fuente para las operaciones mostradas en este ejemplo.|  
|ReceiveLocations.sln y ReceiveLocations.csproj|Archivos de solución y proyecto de este ejemplo.|  
