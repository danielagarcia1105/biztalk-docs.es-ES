...
El adaptador de Microsoft BizTalk para TIBCO Rendezvous permite usar las funciones empresariales de TIBCO Rendezvous en BizTalk Server. En esta sección se introduce el adaptador de BizTalk para TIBCO Rendezvous, se describen las características clave y se proporciona información sobre cómo configurar el adaptador para obtener acceso a información específica de TIBCO Rendezvous.  
