...
|Configuración|: Los administradores del servidor de BizTalk<br />-Local de administradores<br />-Función de SQL Server sysadmin<br />: Los administradores SSO<br />: Administrador de OLAP|  
...
|Crear una base de datos de cuadro de mensajes|: Los administradores del servidor de BizTalk<br />-Función de SQL Server sysadmin|  
