...
-   [Cómo habilitar el cifrado entre Analysis Services y la base de datos de importación principal de BAM](../core/enable-encryption-between-analysis-services-and-bam-primary-import-database.md)  
  
-   [Cómo habilitar servicios de notificación en más equipos en un grupo](../core/how-to-enable-notifications-services-on-additional-computers-in-a-group.md)