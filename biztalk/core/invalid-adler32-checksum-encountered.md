...
---
# <a name="invalid-adler32-checksum-encountered"></a>Suma de comprobación Adler32 no válido encontrado
...
|Texto del mensaje|Suma de comprobación Adler32 no válido encontrado|  
...
## <a name="user-action"></a>Acción del usuario  
 El uso de **suma de comprobación Adler32 no válida encontrada** indica una alta probabilidad de manipulación. Compruebe su manipulación si ve **suma de comprobación Adler32 no válida encontrada**.