...
---
# <a name="known-issues-with-edi-processing"></a>Problemas conocidos del procesamiento de EDI
Esta sección contiene temas que describen problemas conocidos con las soluciones EDI de [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)].  
  
## <a name="in-this-section"></a>En esta sección  
  
-   [Problemas conocidos de EDI de procesamiento de recepción](../core/known-issues-with-edi-receive-processing.md)  
  
-   [Problemas conocidos relacionados con EDI del procesamiento de envío](../core/known-issues-with-edi-send-processing.md)  
  
-   [Problemas conocidos de confirmaciones EDI](../core/known-issues-with-edi-acknowledgments.md)  
  
-   [Problemas conocidos relacionados con el procesamiento por lotes de EDI](../core/known-issues-with-edi-batching.md)  
  
-   [Problemas conocidos relacionados con las entidades EDI](../core/known-issues-with-edi-parties.md)  
  
-   [Problemas conocidos relacionados con la validación de EDI, esquemas y mensajes](../core/known-issues-with-edi-validation-schemas-and-messages.md)  
