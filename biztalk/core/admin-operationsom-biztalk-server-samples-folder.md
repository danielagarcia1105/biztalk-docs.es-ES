...
-   [OperationsSamples (ejemplo de BizTalk Server)](../core/operationssamples-biztalk-server-sample.md). Muestra cómo buscar una instancia MSMQt en el cuadro de mensajes, buscar mensajes, trabajar con instancias y detalles del flujo y del enrutamiento de mensajes, así como recorrer el registro de eventos.