...
- [Permisos para instalar una aplicación](#BKMK_Permissions_for_installing_an_application)  
...
##  <a name="BKMK_Permissions_for_installing_an_application"></a> Permisos para instalar una aplicación  
...
|Registro|Lectura/escritura|Es necesario si la **regsvcs** o **regasm**propiedad está establecida en True para un recurso de ensamblado que contiene administrados componentes COM o COM +.|  
