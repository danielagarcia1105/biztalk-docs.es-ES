---
title: Configuración de Host Local de reserva (configuración de intercambio X12) | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
2. En el **X12 configuración de reserva** cuadro de diálogo el **X12 páginas del acuerdo** , bajo el **configuración de intercambio** sección, haga clic en **configuración de Host Local** .  
