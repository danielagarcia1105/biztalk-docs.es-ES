...
![Paso 9 de 11](../core/media/tut-step9-of-11.gif "Tut_Step9_of_11")  
 ...
 En este paso, puede configurar un puerto de envío para enviar el XML generado a partir de la carga EDI a la aplicación de Contoso back-end, representado por la \\_EDIXMLToContoso carpeta. Este puerto de envío utiliza una canalización de envío PassThruTransmit.  
...
## <a name="next-steps"></a>Pasos siguientes  
 Crear un AS2 y X12 acuerdo entre los dos socios comerciales asociados, como se describe en [paso 10: configurar el X12 y acuerdo entre socios comerciales de AS2](../core/step-10-configure-the-x12-and-as2-trading-partner-agreement.md)  
