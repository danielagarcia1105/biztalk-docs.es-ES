...
Esta sección proporciona información detallada sobre la arquitectura y el funcionamiento interno de Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)].  
...
-   [Arquitectura de solución de AS2 y EDI](../core/edi-and-as2-solution-architecture.md)  
