...
1. Haga clic en **iniciar**, apunte a **todos los programas**, haga clic en [!INCLUDE[btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)]y, a continuación, haga clic en **Editor de perfiles de seguimiento**.  
...
2. En el **archivo** menú, haga clic en **abierto**. Desplácese al archivo .btt correspondiente en el disco duro. Haga clic en **abierto** para cargarlo.  
...
3. En el **herramientas** menú, haga clic en **quitar perfil de seguimiento** para quitar el perfil de seguimiento basado en el archivo .btt desde la base de datos de administración de BizTalk.  
