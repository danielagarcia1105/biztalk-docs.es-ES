...
---
# <a name="single-sign-on-event-10726"></a>Inicio de sesión único: Evento 10726
...
|Identificador del evento|10726|  
|Origen del evento|ENTSSO|  
|Componente|N\D|  
|Nombre simbólico|SSO_ERROR_REPLAY_CORRUPTION|  
|Texto del mensaje|El archivo de reproducción o progreso está dañado.%r<br /><br /> Nombre de archivo: %1 %r<br /><br /> Datos adicionales: %2 %r<br /><br /> Código de error: %3|  
