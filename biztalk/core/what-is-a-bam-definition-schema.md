...
El esquema de definición de BAM define la estructura del modelo de observación que creó el analista de negocios.  
 ...
 El esquema define la estructura del documento XML de definición de BAM, incluidos los elementos y subelementos del documento. Por ejemplo, el elemento raíz es la definición de BAM y, dentro de la definición de BAM, existen los siguientes elementos:  
...
> [!NOTE]
>  Si el XML de definición de BAM contiene dos vistas y el usuario solo tiene permisos para una de las vistas, acerca de cómo realizar una llamada a **GetViewDefinition**, el usuario obtiene la definición de ambas vistas.  
  
 El esquema define las restricciones del documento. Las restricciones indican, por ejemplo, que algunos elementos sólo pueden hacer referencia a otros elementos determinados.  
...
> [!NOTE]
>  Si exporta una definición de BAM como XML, no podrá exportar la definición de BAM al host local. Por ejemplo, al intentar exportar la definición de BAM a `\\localhost\C$\definition1.xml` daría un error como resultado.  
>   
>  De forma similar, no puede importar una definición de BAM desde el host local.  
  
> [!NOTE]
>  Si cambia las actividades o las vistas, es necesario que quite y luego vuelva a implementar la definición de BAM.  
  
 El archivo siguiente es el propio esquema de definición de BAM:  
 ...
 **XML de ejemplo**  
 ...
 El ejemplo siguiente es un archivo XML que se ajusta al esquema de definición de BAM.  
