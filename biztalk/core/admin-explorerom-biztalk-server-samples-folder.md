...
> [!NOTE]
>  Microsoft.BizTalk.ExplorerOM.dll es compatible con procesos de 32 bits y de 64 bits.  
...
-   [OrchestrationBinding (ejemplo de BizTalk Server)](../core/orchestrationbinding-biztalk-server-sample.md). Muestra la configuración y administración de orquestaciones.  
  
-   [PartnerManagement (ejemplo de BizTalk Server)](../core/partnermanagement-biztalk-server-sample.md). Muestra cómo crear y eliminar entidades. También muestra cómo dar de alta y de baja las entidades con funciones.  
