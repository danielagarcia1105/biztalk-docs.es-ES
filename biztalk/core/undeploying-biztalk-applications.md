...
-   **Eliminar la aplicación de BizTalk.** se quitan sus datos de las bases de datos de BizTalk para el grupo de BizTalk. Cuando lo haga, la aplicación ya no se mostrará más en la consola de administración de BizTalk.  
  
-   **Desinstale la aplicación de BizTalk.**  se quitan los archivos y la configuración asociados a la aplicación, así como sus artefactos, del sistema de archivos local.  
  
-   **Quitar otros archivos y configuraciones.** quizás sea necesario quitar otros archivos y configuraciones asociados con la aplicación.  
...
-   [Cómo quitar otros archivos y configuraciones para una aplicación de BizTalk](../core/how-to-remove-other-files-and-settings-for-a-biztalk-application.md)