...
---
# <a name="single-sign-on-event-10801"></a>Inicio de sesión único: Evento 10801
...
|Identificador del evento|10801|  
|Origen del evento|ENTSSO|  
|Componente|N/D|  
|Nombre simbólico|ENTSSO_E_INVALID_NOTIFICATION_TYPE|  
|Texto del mensaje|Tipo de notificación no válido.|  
