...
2.  En la lista de adaptadores expandida, haga clic en **WCF-CustomIsolated**, en el panel derecho, haga el controlador de recepción que desea configurar y, a continuación, haga clic en **propiedades**.  
...
4.  En el **propiedades de transporte de WCF-CustomIsolated** cuadro de diálogo, en la **extensiones de WCF** ficha, realice lo siguiente:  
