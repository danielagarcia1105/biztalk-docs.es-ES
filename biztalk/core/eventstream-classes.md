...
-   Microsoft.Biztalk.BAM.Xlangs.dll: Este archivo DLL es necesaria al codificar para secuencias de eventos de orquestación.  
  
-   Microsoft.BizTalk.Pipeline.dll: Este archivo DLL necesario cuando se usa contextos de canalizaciones de codificación para secuencias de eventos de mensajería.  
