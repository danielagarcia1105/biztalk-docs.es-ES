...
## <a name="summary-of-functionality-supported-by-biztalk-native-adapters"></a>Resumen de funcionalidad compatible con los adaptadores nativos de BizTalk  
...
-   **Compatibilidad con transacciones.** Capacidad para enviar y recibir documentos en el contexto de una transacción de oordinador de transacciones distribuidas (DTC). Esta funcionalidad es necesaria para mantener una entrega ordenada de mensajes y garantizar que los documentos no se duplican ni se pierden.  
  
-   **Compatibilidad con comunicación bidireccional (solicitud/respuesta o petición-respuesta).** Capacidad para enviar un documento y procesar un mensaje de respuesta del destino o recibir un documento y enviar un mensaje de respuesta al origen.  
  
-   **Compatibilidad con recepción por orden.** Capacidad para publicar documentos recibidos en la base de datos de cuadro de mensajes de BizTalk en el orden exacto en que se recibieron los documentos.  
...
|TIBCO Enterprise Message Service|Habilita el intercambio de mensajes con formato de datos XML y binarios entre el servidor BizTalk Server y un servidor TIBCO EMS proporcionando una infraestructura de aplicación de confianza y estrechamente integrada.|[Línea de negocio (LOB) y los sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
 ...
 También puede usar los adaptadores que se suministran con [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)] para conectar con distintos sistemas de línea de negocio. Para obtener más información acerca de [!INCLUDE[adapterpacknoversion](../includes/adapterpacknoversion-md.md)], consulte [http://go.microsoft.com/fwlink/p/?LinkID=188849](http://go.microsoft.com/fwlink/p/?LinkID=188849)  
