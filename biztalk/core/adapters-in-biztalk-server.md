...
## <a name="functionality-support-in-built-in-adapters"></a>Compatibilidad con la funcionalidad en adaptadores integrados  
...
-   **Soporte técnico de recepción por orden** : la capacidad para publicar documentos recibidos en la base de datos de BizTalk MessageBox en el orden exacto en que se recibieron los documentos.  
  
-   **Inicio de sesión único habilitado** : la capacidad de usar la autenticación de inicio de sesión único al enviar o recibir documentos con el adaptador.  
  
-   **Proceso de hospedaje** : el proceso en el que se ejecuta el adaptador. *BizTalk IP* se ejecuta en el proceso BTSNTSvc.exe, mientras que *IIS OOP* ejecutar fuera del proceso de BizTalk Server en el proceso de Internet Information Server (IIS).  
...
|Aplicación lógica| Recibir de y enviar a una aplicación de lógica de Azure. Para un entorno local y en la nube, entornos de utilizar este adaptador para tener acceso a muchos servicios de Azure | Sí | Depende de su diseño de flujo de trabajo | no | no |Recibe: IP de BizTalk<br/>Envío: OOP de IIS| 
...
|Calendario de Office 365 | Recibir y crear eventos de Office 365 | | no | No en orden de recepción | no | IP de BizTalk| 
|Contacto de Office 365 | Crear contactos de Office 365 | | no | No en orden de recepción | no | IP de BizTalk| 
...
## <a name="enterprise-adapters"></a>Adaptadores empresariales  
...
|---|---|---|  
|PeopleSoft Enterprise|Habilita el intercambio de mensajes de interfaz de componentes entre el servidor BizTalk Server y un sistema PeopleSoft.|[Línea de negocio (LOB) y sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
|JD Edwards OneWorld XE|Habilita el intercambio de mensajes de funciones empresariales entre el servidor BizTalk Server y un sistema JD Edwards OneWorld.|[Línea de negocio (LOB) y sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
|JD Edwards EnterpriseOne|Habilita el intercambio de mensajes de funciones empresariales entre el servidor BizTalk Server y un sistema EnterpriseOne.|[Línea de negocio (LOB) y sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
|TIBCO Rendezvous|Habilita el intercambio de mensajes con formato de datos XML y binarios entre el servidor BizTalk Server y TIBCO Rendezvous.|[Línea de negocio (LOB) y sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
|TIBCO Enterprise Message Service|Habilita el intercambio de mensajes con formato de datos XML y binarios entre el servidor BizTalk Server y un servidor TIBCO EMS proporcionando una infraestructura de aplicación de confianza y estrechamente integrada.|[Línea de negocio (LOB) y sistemas empresariales compatibles](http://social.technet.microsoft.com/wiki/contents/articles/17631.biztalk-server-supported-line-of-business-lob-and-enterprise-systems.aspx)|  
