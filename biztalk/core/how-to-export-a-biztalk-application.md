---
title: Cómo exportar una aplicación de BizTalk | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
3. Haga clic en la aplicación que desea exportar, elija **exportar**y, a continuación, haga clic en **archivo MSI**.  
  
4. En la bienvenida a la página del Asistente para exportar archivos MSI, haga clic en **siguiente**.  
...
10. En la página Resumen, anote la ubicación del archivo de registro para esta operación y, a continuación, haga clic en **finalizar**.  
...
2. Escriba el siguiente comando, sustituyendo los valores según corresponda, como se describe en la tabla que se presenta a continuación:  
    ...
    **ExportApp de BTSTask** [**/ApplicationName:**<em>valor</em>] **/paquete:**<em>valor</em> [**ResourceSpec:**  <em>valor</em> [**/Server:**<em>valor</em>] [**/Database:**<em>valor</em>]  
