...
|Texto del mensaje|Error al analizar. El X12 contiene el conjunto de transacciones con identificador '{0}' en grupo funcional con Id. '{1}', en el intercambio con Id. '{2}', con el remitente Id. '{3}', Id. de destinatario '\{4\' se está suspendiendo por los errores siguientes:|  
