...
---
# <a name="addresource-command-biztalk-binding"></a>AddResource (comando): Enlace de BizTalk
Para agregar un archivo de enlace a una aplicación de BizTalk, usa el **AddResource** comando y especifique **BizTalk: biztalkbinding** para el **tipo** parámetro. Cuando agrega un archivo de enlace, puede especificar un entorno de implementación para él. Cuando importa posteriormente la aplicación, puede seleccionar este entorno de implementación para aplicar los enlaces. Puede agregar cualquier número de archivos de enlace a una aplicación de BizTalk, cada uno personalizado para un entorno de implementación diferente. Para agregar varios archivos de enlace, ejecute este comando para cada archivo que desee agregar.  
  
 Puede agregar un archivo de enlace que haya exportado de un ensamblado, aplicación o grupo, como se describe en [ExportBindings (comando)](../core/exportbindings-command.md)y, a continuación, utilice el comando AddResource para agregar el archivo de enlace a una aplicación.  
...
3. Los enlaces que se ha agregado explícitamente y que tienen un entorno de implementación de destino asociado que coincide con el entorno de implementación seleccionado para la importación de la aplicación. Los enlaces de este conjunto no se aplican en ningún orden específico.  
   ...
   Para obtener más información, consulte [cómo importar una aplicación de BizTalk](../core/how-to-import-a-biztalk-application.md). Para obtener información general sobre el uso de los archivos de enlace, consulte [archivos de enlace e implementación de aplicaciones](../core/binding-files-and-application-deployment.md).  
  
## <a name="usage"></a>Uso  
 **BTSTask AddResource** [**/ApplicationName: "**<em>valor</em>**"**] **/Type:System.BizTalk:BizTalkBinding/Property: TargetEnvironment = "**<em>valor</em>**"** [**/Overwrite**] **/Source:**<em>valor</em> [**/Server:**<em>valor</em>] [**/Database:**<em>valor</em>]  
...
|**/ Escriba** (o **/T**, vea la sección Comentarios)|Sí|**BizTalk: biztalkbinding** (este valor no distingue mayúsculas de minúsculas).|  
