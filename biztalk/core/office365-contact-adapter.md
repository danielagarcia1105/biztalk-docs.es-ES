...
5. Copia **Office365Contact.xml** mensaje de ejemplo en la carpeta de recepción (C:\Temp\In\). El puerto de envío crea un contacto en su cuenta de Office 365 Outlook basado en el documento xml.
