...
|          **-ImportTrackingSettings**          | Opcional |                                                                                                                                           Nuevo a partir de [!INCLUDE[bts2016_md](../includes/bts2016-md.md)]. <br /><br />Esto invalida la opción de importación de configuración de seguimiento global. El valor "true" permite importar configuración seguimiento. False no permite la importación de configuración de seguimiento.                                                                                                                                           |
|              **-ExcludeParties**              | Opcional |                                                                                                                                                                                 Nuevo a partir de [!INCLUDE[bts2016_md](../includes/bts2016-md.md)]. <br /><br />Si se especifica, excluye la información de las partes del archivo de enlace.                                                                                                                                                                                  |
