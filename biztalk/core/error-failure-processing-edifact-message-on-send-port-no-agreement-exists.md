...
|Nombre simbólico|-|  
|Texto del mensaje|Error al procesar el mensaje Edifact en el puerto de envío {0}. No existen acuerdos de pares de calificador o identificador de destinatario y remitente de {1}, {2}, {3}, \{4\. No existe ninguna entidad con nombre {5}.|  
