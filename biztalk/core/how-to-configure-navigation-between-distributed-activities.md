...
1.  El administrador del equipo 1 concede al usuario empresarial acceso a la vista myBusinessView en el equipo 1. Use el comando bm.exe, como se indica a continuación: **agregar-account - AccountName:\<nombre de cuenta >-View:** myBusinessView  
