...
- La solución está diseñada para intercambios que utilizan la codificación X12, no la codificación EDIFACT.  
  ...
  > [!NOTE]
  >  La configuración que se usa para HIPAA es bastante parecida a la que se usa para la codificación X12. Para obtener instrucciones sobre cómo crear una solución similar para EDIFACT, vea [tutorial (EDIFACT): devolución de una confirmación de envío y recepción de intercambios EDI](../core/walkthrough-edifact--receive-edi-interchanges-and-send-an-acknowledgement.md).  
...
- Para realizar pruebas, la solución usa tres puertos de envío para enviar el intercambio EDI y las confirmaciones creadas a carpetas locales.  
  ...
  ![Recepción de intercambios EDI](../core/media/c54cca56-c658-4081-9e2f-bf28ba647cda.gif "c54cca56-c658-4081-9e2f-bf28ba647cda")  
...
7. Realizar las tareas siguientes en el **Fabrikam -> Contoso** ficha.  
   ...
   2. En el **confirmación** página bajo la **configuración de intercambio** sección, verificación **TA1 esperado** y **997 esperado**.  
   ...
   4. En el **juego de caracteres y separadores** página bajo la **configuración de intercambio** sección, seleccione el **CR LF** opción.  

   5. En el **configuración de Host Local** página bajo la **configuración de intercambio** sección, desactive la **enrutar confirmación para la canalización de envío de solicitud-respuesta de puerto de recepción** opción.  
