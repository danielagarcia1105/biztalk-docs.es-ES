...
---
# <a name="preparing-to-use-peoplesoft-enterprise"></a>Preparación para usar PeopleSoft Enterprise
Para obtener información sobre cómo preparar el sistema de Peoplesoft Enterprise para usarlo con Microsoft BizTalk Adapter para Peoplesoft Enterprise, consulte la [guía para la instalación de aplicaciones empresariales de Microsoft BizTalk Adapters](../adapters-and-accelerators/install-configure-biztalk-adapters-enterprise-applications.md). 
