...
|  Texto del mensaje   | El límite máximo aceptable X12 ha alcanzado el número de control de conjunto de transacciones para entidades {0}. Para restablecer el contador, desplácese hasta Entidad, en la pantalla de función del destinatario, campo ST 2, del administrador de acuerdos de socios comerciales. |
