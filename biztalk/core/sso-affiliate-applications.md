...
|appTicketTimeOut|Especifica un tiempo de espera de vales específico para la aplicación afiliada. Se puede establecer únicamente al actualizar una aplicación afiliada, no al crearla.<br /><br /> Si compra de vales está habilitada para esta aplicación y esta propiedad es no, el tiempo de espera especificado en el sistema de SSO (Global) se usa el nivel.<br /><br /> **Seguridad** debe ser un administrador de SSO para establecer este indicador.|  
