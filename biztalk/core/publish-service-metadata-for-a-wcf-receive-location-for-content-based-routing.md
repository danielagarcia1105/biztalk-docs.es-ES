---
title: Cómo usar el Asistente de publicación de servicios de WCF de BizTalk para publicar los metadatos del servicio de ubicación de recepción de WCF para enrutamiento por contenidos | Documentos de Microsoft
ms.custom: ''
ms.date: 06/08/2017
...
6.  En el **servicio WCF** , defina los contratos de servicio WCF para publicar metadatos de servicio. Utilice el árbol en el **descripción de servicio Web** cuadro de diálogo para agregar, quitar, cambiar el nombre y editar los nodos de descripción del servicio Web para los servicios WCF que se va a publicar. El **información** cuadro de diálogo proporciona información sobre el nodo seleccionado y muestra todos los errores en el nodo actual o en cualquier subnodo:  
    ...
    -   El nodo de método Web, **Operation1**, del nodo de servicio predeterminado, **Service1**, como se muestra de forma predeterminada en el **descripción de servicio Web** cuadro de diálogo puede usarse para un ubicación de recepción de solicitud-respuesta. Si ha seleccionado un WCF unidireccional ubicación de recepción para este contrato de servicio, haga clic en el nodo de método Web, haga clic en **Eliminar método web**y, a continuación, cree un método Web unidireccional como sigue: menú contextual del nodo de servicio predeterminado, punto para **Agregar método web**y, a continuación, haga clic en **unidireccional**.  
...
1.  Habilite ASP.NET para la aplicación web que ha creado el Asistente para publicación de Servicio WCF de BizTalk. Para obtener más información, consulte [habilitar servicios Web](../core/enabling-web-services.md).  
