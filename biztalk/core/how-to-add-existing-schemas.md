...
### <a name="to-add-an-existing-schema"></a>Para agregar un esquema existente  
  
1.  En **el Explorador de soluciones**, seleccione el proyecto de BizTalk al que desea agregar un esquema existente.  
