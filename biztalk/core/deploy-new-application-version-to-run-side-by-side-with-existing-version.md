...
6. Cree los puertos de envío adecuado según sea necesario, como se describe en [cómo crear un puerto de envío](../core/how-to-create-a-send-port2.md).  
  
7. Enlazar la nueva aplicación recién creado de recepción y puertos de envío, tal como se describe en [cómo configurar una aplicación](../core/how-to-configure-an-application.md).  
  
8. Exportar la aplicación a un archivo .msi en el entorno de prueba, como se describe en [cómo exportar una aplicación de BizTalk](../core/how-to-export-a-biztalk-application.md).  
