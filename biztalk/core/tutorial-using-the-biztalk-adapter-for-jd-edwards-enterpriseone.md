...
## <a name="in-this-section"></a><span data-ttu-id="f376b-107">En esta sección</span><span class="sxs-lookup"><span data-stu-id="f376b-107">In This Section</span></span>  
  
-   [<span data-ttu-id="f376b-108">Paso 1: Hacer referencia al esquema DLL</span><span class="sxs-lookup"><span data-stu-id="f376b-108">Step 1: Reference the Schema DLL</span></span>](../core/step-1-reference-the-schema-dll1.md)  
  
-   [<span data-ttu-id="f376b-109">Paso 2: Crear la orquestación</span><span class="sxs-lookup"><span data-stu-id="f376b-109">Step 2: Create the Orchestration</span></span>](../core/step-2-create-the-orchestration2.md)  
  
-   [<span data-ttu-id="f376b-110">Paso 3: Completar y ejecutar el proyecto</span><span class="sxs-lookup"><span data-stu-id="f376b-110">Step 3: Complete and Run the Project</span></span>](../core/step-3-complete-and-run-the-project1.md)  
  
-   [<span data-ttu-id="f376b-111">Paso 4: Crear un XML de ejemplo de BeginDoc</span><span class="sxs-lookup"><span data-stu-id="f376b-111">Step 4: Create a Sample XML BeginDoc</span></span>](../core/step-4-create-a-sample-xml-begindoc2.md)