...
- Haga que el remitente sea un puerto de enlace directo de cuadro de mensajes y promocione propiedades que coincidan con una suscripción en la orquestación de recepción.  
  ...
  Para configurar un puerto orquestación de socio directo dependiente, en el Asistente para configuración de puerto, especifique **directo** para **enlace de puerto** y seleccione **para recibir mensajes de otras orquestaciones, Seleccione este puerto aquí y en dichas orquestaciones** o **para enviar mensajes a otras orquestaciones, seleccione este puerto aquí y en dichas orquestaciones** dependiendo de si va a recibir o enviar mensajes Este puerto. A continuación, seleccione el puerto desde el **puerto en orquestación de socio** lista desplegable. El tipo de puerto de ambos puertos debe ser el mismo, lo que significa que el tipo de mensaje también debe ser el mismo. Además, para poder enlazar directamente a un puerto de orquestación de socio, el **modificador de tipo** del puerto de tipo debe ser **interno** para orquestaciones dentro del mismo ensamblado o **pública**  para permitir que una orquestación de otro ensamblado, enlazar a él. Las polaridades de los puertos deben ser opuestas. Por ejemplo, si un extremo es un puerto de envío, el otro debe ser de recepción.  
 ...
 **Para configurar el enlace directo de orquestación de socio de avance, realice lo siguiente:**  
  
1. En la orquestación A, seleccione el **puerto** forma en el cuadro de herramientas de orquestaciones. De esta forma, se inicia el Asistente para configuración de puertos.  
  
2. En el **propiedades de puerto** página, en el **nombre** , escriba `MyReceivePort`. Haga clic en **Siguiente**.  
  
3. En el **seleccione un tipo de puerto** , seleccione **crear un nuevo tipo de puerto**. En el **nombre de tipo de puerto** , escriba `MyPartnerPortType`. Haga clic en **Siguiente**.  
  
4. En el **enlace de puerto** página, en el **dirección de puerto de comunicación** lista desplegable, seleccione **siempre recibiré los mensajes en este puerto**. En el **enlace de puerto** lista desplegable, seleccione **directo**.  
  
5. Seleccione **para recibir mensajes de otras orquestaciones, seleccione este puerto aquí y en dichas orquestaciones**y, a continuación, en el **puerto en orquestación de socio** lista desplegable, seleccione  **OrchestrationA.MyReceivePort**. Haga clic en **Siguiente**.  
...
8. En el **propiedades de puerto** página, en el **nombre** , escriba `MySendPort`. Haga clic en **Siguiente**.  
...
10. En el **enlace de puerto** página, en el **dirección de puerto de comunicación** lista desplegable, seleccione **siempre enviaré los mensajes en este puerto**. En el **enlace de puerto** lista desplegable, seleccione **directo**.  
  
11. Seleccione **para enviar mensajes a otras orquestaciones, seleccione este puerto aquí y en dichas orquestaciones**y, a continuación, en el **puerto en orquestación de socio** lista desplegable, seleccione  **OrchestrationA.MyReceivePort**. Haga clic en **Siguiente**.  
 ...
 **Para configurar el enlace directo de orquestación de socio inverso, realice lo siguiente:**  
  
1. En la orquestación A, seleccione el **puerto** forma en el cuadro de herramientas de orquestaciones. De esta forma, se inicia el Asistente para configuración de puertos.  
  
2. En el **propiedades de puerto** página, en el **nombre** , escriba `MySendPort`. Haga clic en **Siguiente**.  
  
3. En el **seleccione un tipo de puerto** , seleccione **crear un nuevo tipo de puerto**. En el **nombre de tipo de puerto** , escriba `MyPartnerPortType`. Haga clic en **Siguiente**.  
  
4. En el **enlace de puerto** página, en el **dirección de puerto de comunicación** lista desplegable, seleccione **siempre enviaré los mensajes en este puerto**. En el **enlace de puerto** lista desplegable, seleccione **directo**.  
  
5. Seleccione **para enviar mensajes a otras orquestaciones, seleccione este puerto aquí y en dichas orquestaciones**y, a continuación, en el **puerto en orquestación de socio** lista desplegable, seleccione  **OrchestrationA.MySendPort**. Haga clic en **Siguiente**.  
  
6. En el **completar el Asistente para puertos** página, haga clic en **finalizar**.  
  
7. En la orquestación B, seleccione el **puerto** forma en el cuadro de herramientas de orquestaciones. De esta forma, se inicia el Asistente para configuración de puertos.  
  
8. En el **propiedades de puerto** página, en el **nombre** , introduzca `MyReceivePort`. Haga clic en **Siguiente**.  
  
9. En la página **Seleccione un tipo de puerto** , seleccione **Utilizar un tipo de puerto existente**. En **tipos de puertos disponibles**, seleccione **MyPartnerPortType**y, a continuación, haga clic en **siguiente**.  
  
10. En el **enlace de puerto** página, en el **dirección de puerto de comunicación** lista desplegable, seleccione **siempre recibiré los mensajes en este puerto**. En el **enlace de puerto** lista desplegable, seleccione **directo**.  
  
11. Seleccione **para recibir mensajes de otras orquestaciones, seleccione este puerto aquí y en dichas orquestaciones**y, a continuación, en el **puerto en orquestación de socio** lista desplegable, seleccione  **OrchestrationA.MySendPort**. Haga clic en **Siguiente**.  
