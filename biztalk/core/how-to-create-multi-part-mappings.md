...
Si tiene varias asignaciones que se utilizan juntas, necesitará combinarlas en una orquestación para probarlas conjuntamente. El **comprobar asignación** comando funciona en solo una asignación a la vez.  
 ...
 Para obtener más información sobre el diseño y uso de orquestaciones, consulte [crear orquestaciones utilizando Diseñador de orquestaciones](../core/creating-orchestrations-using-orchestration-designer.md).  
