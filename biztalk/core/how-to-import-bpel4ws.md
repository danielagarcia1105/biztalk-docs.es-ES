...
>  Esta versión de BizTalk Server es compatible con BPEL4WS 1.1. No es compatible con BPEL4WS 1.0 para realizar importaciones o exportaciones.  
 ...
 Para obtener un ejemplo de cómo importar BPEL4WS, consulte [importar de BPEL (ejemplo de BizTalk Server)](../core/bpel-import-biztalk-server-sample.md).  
...
-   xsd: QName no es compatible; se importa como System.String. Utilice xsd: String.  
