...
-   Se recibe un mensaje XML pero no se ha implementado ningún esquema para él.  
 ...
 Un mensaje desconocido se controla en función de la **permitir mensaje desconocido** propiedad (o en la **XMLNorm.AllowUnrecognizedMessage** propiedad en el contexto del mensaje).  
...
> [!NOTE]
>  No se procesan mensajes que no sean XML el Desensamblador de XML sin tener en cuenta el **permitir mensaje desconocido** configuración de la propiedad.  
