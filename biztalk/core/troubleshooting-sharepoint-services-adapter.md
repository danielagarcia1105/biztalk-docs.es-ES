---
title: Solución de problemas de SharePoint de servicios de adaptador | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
 ...
 **Escenario de salto doble**  
 ...
 Esta solicitud POST del adaptador de BizTalk debe completarse correctamente. Si sospecha que existe algún error de autenticación, revise los registros de IIS. De forma predeterminada, los registros de IIS están en c:\inetpub\logs\LogFiles\W3SVC*x*. La solicitud POST debe mostrar el código de estado 200 (operación llevada a cabo correctamente). Si se devuelve un código de estado de error, como un 401.2, seguido por un 401.1, seguido de otro 4*xx* error y, a continuación, la autenticación puede tener errores.  
...
3. En el controlador de dominio, vaya a **equipos y usuarios de Active Directory** y realice lo siguiente:  
