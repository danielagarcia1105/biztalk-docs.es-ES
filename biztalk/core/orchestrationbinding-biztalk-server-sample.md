...
- Este ejemplo requiere que se ha implementado el ejemplo HelloWorld mediante la ejecución de setup.bat ubicado en el \< *ruta de ejemplos*\>directory \Orchestrations\HelloWorld.  
...
## <a name="where-to-find-this-sample"></a>Dónde encontrar este ejemplo  
 ...
 \<*Ejemplos de la ruta de acceso*\>\Admin\ExplorerOM\OrchestrationBinding  
...
1.  Abra una ventana de comandos y desplácese a la siguiente carpeta:  
     ...
     \<*Ejemplos de la ruta de acceso*\>\Admin\ExplorerOM\OrchestrationBinding\bin\Debug  
