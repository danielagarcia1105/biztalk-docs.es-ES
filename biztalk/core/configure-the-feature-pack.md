...
[!INCLUDE[btsBizTalkServerNoVersion_md](../includes/btsbiztalkservernoversion-md.md)]usa el feature pack para proporcionar una integración más estrecha con Azure, mejoras y características. [!INCLUDE[featurepack1](../includes/featurepack1.md)]amplía la funcionalidad en áreas clave, como la implementación, análisis y en tiempo de ejecución. 
...
Use las API de REST para administrar de forma remota su artifiacts de BizTalk, incluidos los contratos, las instancias suspendidas, dado de baja orquestaciones y mucho más.
