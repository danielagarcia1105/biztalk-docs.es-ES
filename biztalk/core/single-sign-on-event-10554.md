...
---
# <a name="single-sign-on-event-10554"></a>Inicio de sesión único: Evento 10554
...
|Identificador del evento|10554|  
|Origen del evento|ENTSSO|  
|Componente|N/D|  
|Nombre simbólico|SSO_ERROR_LOOKUP_CALLBACK_ACCESS_DENIED|  
|Texto del mensaje|Acceso denegado al servidor de búsqueda.%r|  
