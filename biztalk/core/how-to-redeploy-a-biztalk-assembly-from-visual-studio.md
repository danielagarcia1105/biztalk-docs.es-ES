...
3.  Escriba el siguiente comando, sustituyendo los valores según corresponda, como se describe en la tabla que se presenta a continuación:  
     ...
     **Devenv /Deploy***Nombreconfigsolución* *SolutionName*   
