...
3.  Tipo ** ssomanage-displayapp *\<nombre de la aplicación\>***, donde *\<nombre de la aplicación\>* es el nombre de la aplicación afiliada que desea mostrar las propiedades de.  
...
3.  Tipo ** ssoclient – displayapp *\<nombre de la aplicación\>***, donde *\<nombre de la aplicación\>* es el nombre de la aplicación afiliada que desea mostrar las propiedades de.  
