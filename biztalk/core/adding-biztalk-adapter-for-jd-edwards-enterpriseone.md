...
1.  En **administración de BizTalk Server**, expanda **aplicaciones**y, a continuación, expanda la aplicación que se va a hospedar los artefactos
...
Las propiedades del transporte JD Edwards EnterpriseOne se usan para el diseño y el tiempo de ejecución. En **propiedades de transporte**, establecer los parámetros de conexión y credenciales específicas para el sistema de servidor y los objetos que está intentando obtener acceso.  
...
3.  En **propiedades de puerto de envío**, seleccione **nombre**y el nombre de este puerto. Por ejemplo, escriba `JDEEnterpriseOneSend`.  
  
4.  En **General**, en la **tipo de transporte** cuadro, seleccione **JDE EnterpriseOne** en la lista desplegable.  
...
6.  En el **propiedades de transporte de JDE EnterpriseOne**propiedades, expanda el **propiedades necesarias del adaptador**y escriba toda la información necesaria para la conexión al servidor de JD Edwards EnterpriseOne.  Use las directrices siguientes para establecer las propiedades de transporte:  
...
> [!NOTE]
>  browsingagent.exe no se actualiza hasta que termina la sesión de examen actual. Por ejemplo, debe salir "Agregar elemento generado …" sesión de exploración y vuelva a escribir para actualizar browsingagent.exe.  
...
#### <a name="single-sign-on"></a>Inicio de sesión único  
 ...
 Para obtener más información e instrucciones básicas sobre la configuración de seguridad de inicio de sesión único, vea [seguridad en el adaptador de BizTalk para JD Edwards EnterpriseOne](../core/security-in-biztalk-adapter-for-jd-edwards-enterpriseone.md).
