...
---
# <a name="single-sign-on-event-10501"></a>Inicio de sesión único: Evento 10501
...
|Texto del mensaje|Se está iniciando el servicio SSO.%r<br /><br /> Nombre de equipo: %1 %r<br /><br /> Nombre SQL Server: %2 %r<br /><br /> Nombre de la base de datos SSO: %3 %r<br /><br /> Uso de SSL. Cifrado de protocolo aplicado para conexiones de SQL Server.|  
