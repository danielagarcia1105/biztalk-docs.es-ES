...
|Herramienta|Tarea|  
|----------|----------|  
|Herramienta BizTalk Health Monitor (BHM)|Un complemento de MMC para los usuarios supervisar el estado de los entornos de BizTalk Server, detectar problemas críticos y no críticos y ejecutar tareas de mantenimiento.  [Descargar BizTalk Health Monitor](https://www.microsoft.com/download/details.aspx?id=43716).|  
