...
> [!NOTE]
>  Al iniciar un puerto de envío o un grupo de puertos de envío, se dan de alta de forma automática. Además, de forma predeterminada, al iniciar una aplicación se dan de alta y se inician todos sus artefactos. Para obtener más información, consulte [cómo iniciar un puerto de envío o grupo de puertos de envío](../core/how-to-start-a-send-port-or-send-port-group.md). Consulte también [cómo iniciar y detener una aplicación de BizTalk](../core/how-to-start-and-stop-a-biztalk-application.md).  
...
3.  Haga clic en **puertos de envío** o **grupos de puertos de envío**, haga clic en el puerto de envío o grupo de puertos de envío y, a continuación, haga clic en **dar de alta**.  
