...
##  <a name="step1"></a><span data-ttu-id="ecb97-107">Preparar el equipo para instalar las versiones de adaptador y en línea de la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-107">Prepare the computer for installing the adapter and inline versions of the Service Oriented Solution</span></span>  
...
4.  <span data-ttu-id="ecb97-116">En un símbolo del sistema, escriba el comando siguiente y, a continuación, presione ENTRAR para establecer la variable de entorno %BTSSolutionsPath%.</span><span class="sxs-lookup"><span data-stu-id="ecb97-116">At a command prompt, type the following command, and then press ENTER to set the %BTSSolutionsPath% environment variable.</span></span> <span data-ttu-id="ecb97-117">A continuación, cierre el símbolo del sistema.</span><span class="sxs-lookup"><span data-stu-id="ecb97-117">Then, exit the command prompt.</span></span>  
    ...
    -   <span data-ttu-id="ecb97-118">setx BTSSolutionsPath [!INCLUDE[btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]SDK\Scenarios"</span><span class="sxs-lookup"><span data-stu-id="ecb97-118">setx BTSSolutionsPath [!INCLUDE[btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]SDK\Scenarios"</span></span>  
...
1.  <span data-ttu-id="ecb97-145">Instalar IBM WebSphere MQ para Windows Server en el equipo local.</span><span class="sxs-lookup"><span data-stu-id="ecb97-145">Install IBM WebSphere MQ for Windows Server on the local computer.</span></span>  
    ...
    2.  <span data-ttu-id="ecb97-149">Instale Fix Pack10 (CSD10).</span><span class="sxs-lookup"><span data-stu-id="ecb97-149">Install the Fix Pack 10 (CSD10).</span></span> <span data-ttu-id="ecb97-150">Mantenga todos los valores de configuración predeterminados.</span><span class="sxs-lookup"><span data-stu-id="ecb97-150">Keep all the default settings.</span></span>  
...
4.  <span data-ttu-id="ecb97-175">Repita el paso anterior para crear las colas locales siguientes para el simulador de seguimiento de pago</span><span class="sxs-lookup"><span data-stu-id="ecb97-175">Repeat the previous step to create the following local queues for the Payment Tracker simulator.</span></span> <span data-ttu-id="ecb97-176">(el simulador de seguimiento de pago se utiliza tanto en la versión de adaptador como en la versión en línea):</span><span class="sxs-lookup"><span data-stu-id="ecb97-176">(The Payment Tracker simulator is used in both the adapter and inline versions):</span></span>  
    ...
    -   <span data-ttu-id="ecb97-177">LastPaymentsInputQueue</span><span class="sxs-lookup"><span data-stu-id="ecb97-177">LastPaymentsInputQueue</span></span>  
...
1.  <span data-ttu-id="ecb97-190">En la carpeta %BTSSolutionsPath%\SO\MFAccess\HISTIComponent, abra el archivo bizcbl.txt y su "libro de copia" (MainFrameProgramVTCS2Description.txt) con el Bloc de notas y, a continuación, revise su contenido.</span><span class="sxs-lookup"><span data-stu-id="ecb97-190">Using Notepad, open the bizcbl.txt and its "copy book" (MainFrameProgramVTCS2Description.txt) in the %BTSSolutionsPath%\SO\MFAccess\HISTIComponent folder, and then review the contents.</span></span>  
...
3.  <span data-ttu-id="ecb97-216">En el **certificado de servicio** página, seleccione **crear un nuevo certificado**y, a continuación, haga clic en **siguiente**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-216">On the **Service Certificate** page, select **Create a new certificate**, and then click **Next**.</span></span>  
...
1.  <span data-ttu-id="ecb97-291">En un símbolo del sistema, ejecute %systemroot%\system32\com\comexp.msc.</span><span class="sxs-lookup"><span data-stu-id="ecb97-291">At a command prompt, run %systemroot%\system32\com\comexp.msc.</span></span>  
...
2.  <span data-ttu-id="ecb97-292">En **servicios de componentes** de la consola, expanda **servicios de componentes**, expanda **equipos**, expanda **Mi PC**, haga clic en  **La aplicación COM +**, seleccione **New**y, a continuación, haga clic en **aplicación**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-292">In **Component Services** console, expand **Component Services**, expand **Computers**, expand **My Computer**, right-click **COM+ Application**, point to **New**, and then click **Application**.</span></span>  
    ...
    7.  <span data-ttu-id="ecb97-305">En el **finalización** página, haga clic en **finalizar**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-305">On the **Completion** page, click **Finish**.</span></span>  
...
2.  <span data-ttu-id="ecb97-328">En el Explorador de Windows, vaya a la carpeta %BTSSolutionsPath%\SO\MFAccess\ y, a continuación, ejecute SetupMFAccess.bat.</span><span class="sxs-lookup"><span data-stu-id="ecb97-328">In Windows Explorer, browse to the %BTSSolutionsPath%\SO\MFAccess\ folder, and then run SetupMFAccess.bat.</span></span>  
...
4.  <span data-ttu-id="ecb97-348">En el **Internet Information Services (IIS) Manager**, expanda **sitios Web**, haga clic en el **sitio Web predeterminado**, seleccione **nuevo**, y a continuación, haga clic en **directorio Virtual** para ejecutar **Asistente para crear un directorio Virtual**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-348">In the **Internet Information Services (IIS) Manager**, expand **Web Sites**, right-click the **Default Web Site**, point to **New**, and then click **Virtual Directory** to run **Virtual Directory Creation Wizard**.</span></span>  
     ...
     <span data-ttu-id="ecb97-350">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.OrchProxy.Inline</span><span class="sxs-lookup"><span data-stu-id="ecb97-350">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.OrchProxy.Inline</span></span>  
...
-   <span data-ttu-id="ecb97-358">En un símbolo del sistema, cambie el directorio a % BTSSolutionsPath%\SO\BTSSoln, escriba `SetupBTSSoln.bat`, y, a continuación, presione ENTRAR.</span><span class="sxs-lookup"><span data-stu-id="ecb97-358">At a command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln, type `SetupBTSSoln.bat`, and then press ENTER.</span></span> <span data-ttu-id="ecb97-359">El archivo SetupBTSSoln.bat realiza las tareas siguientes:</span><span class="sxs-lookup"><span data-stu-id="ecb97-359">The SetupBTSSoln.bat performs the following tasks:</span></span>  
    ...
    -   <span data-ttu-id="ecb97-362">Genera la solución SO.</span><span class="sxs-lookup"><span data-stu-id="ecb97-362">Builds the SO solution.</span></span>  
...
2.  <span data-ttu-id="ecb97-366">En el símbolo del sistema, abra el archivo PendTransAffApp.xml con el Bloc de notas y revíselo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-366">At the command prompt, open the PendTransAffApp.xml using Notepad, and review it.</span></span> <span data-ttu-id="ecb97-367">No es necesario realizar cambios en este archivo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-367">No changes to this file are necessary.</span></span>  
    ...
    >   
    >  <span data-ttu-id="ecb97-373">Para obtener más información sobre las aplicaciones afiliadas SSO, vea [aplicaciones afiliadas de SSO](../core/sso-affiliate-applications.md).</span><span class="sxs-lookup"><span data-stu-id="ecb97-373">For more information about SSO affiliate applications, see [SSO Affiliate Applications](../core/sso-affiliate-applications.md).</span></span>  
  
3.  <span data-ttu-id="ecb97-374">En el símbolo del sistema, abra el archivo PendTransUserMap.xml con el Bloc de notas y, a continuación, realice las siguientes modificaciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-374">At the command prompt, open the PendTransUserMap.xml file using Notepad, and then make the following edits:</span></span>  
    ...
    > [!NOTE]
    >  <span data-ttu-id="ecb97-375">El archivo PendTransUserMap.xml contiene las asignaciones de usuario para el sistema de servidor de transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-375">The PendTransUserMap.xml file contains the user mappings for the Pending Transactions back-end system.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-376">Para el **externalUserId** nodo, use el identificador de usuario externo para el sistema de back-end de transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-376">For the **externalUserId** node, use the external user ID for the Pending Transactions back-end system.</span></span> <span data-ttu-id="ecb97-377">Para este tutorial, utilice UserID como identificador externo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-377">For this walkthrough, use UserID for the external ID.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-378">Para el **windowsUserId** nodo, escriba el usuario que el nombre del **externalUserId** se asignarán a.</span><span class="sxs-lookup"><span data-stu-id="ecb97-378">For the **windowsUserId** node, enter the user name which the **externalUserId** will map to.</span></span> <span data-ttu-id="ecb97-379">Puede utilizar tanto un grupo de dominio como una cuenta de usuario de dominio.</span><span class="sxs-lookup"><span data-stu-id="ecb97-379">You can use both a domain group and a domain user account.</span></span> <span data-ttu-id="ecb97-380">El usuario debe ser miembro del grupo al que se permitirá utilizar el sistema de servidor de transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-380">This user must be a member of the group that will be allowed to use the Pending Transactions back-end system.</span></span> <span data-ttu-id="ecb97-381">En este tutorial, utilice el nombre de usuario del servicio de BizTalk.</span><span class="sxs-lookup"><span data-stu-id="ecb97-381">For this walkthrough, use the user name of the BizTalk service.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-382">Para el **windowsDomain** nodo, escriba el nombre de dominio de la **windowsUserId**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-382">For the **windowsDomain** node, enter the domain name of the **windowsUserId**.</span></span>  
  
4.  <span data-ttu-id="ecb97-383">En el símbolo del sistema, abra el archivo PmntTrckAffApp.xml con el Bloc de notas y, a continuación, analice su contenido.</span><span class="sxs-lookup"><span data-stu-id="ecb97-383">At the command prompt, open the PmntTrckAffApp.xml file using Notepad, and review the contents of the file.</span></span> <span data-ttu-id="ecb97-384">No es necesario realizar cambios en este archivo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-384">No changes to this file are necessary.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-385">El archivo PmntTrckAffApp.xml define la aplicación afiliada SSO WoodgroveBank.PaymentTracker para el sistema de servidor de seguimiento de pago.</span><span class="sxs-lookup"><span data-stu-id="ecb97-385">The PmntTrckAffApp.xml file defines the SSO affiliate application, WoodgroveBank.PaymentTracker, for the Payment Tracker back-end system.</span></span>  
  
5.  <span data-ttu-id="ecb97-386">En el símbolo del sistema, abra el archivo PmntTrckUserMap.xml con el Bloc de notas y, a continuación, realice las siguientes modificaciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-386">At the command prompt, open the PmntTrckUserMap.xml file using Notepad, and then make the following edits:</span></span>  
    ...
    > [!NOTE]
    >  <span data-ttu-id="ecb97-387">La aplicación afiliada SSO de seguimiento de pago se utilizará para el adaptador de MQSeries, y el Id. de usuario y contraseña externos asignados se enviarán con las propiedades de encabezado de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-387">The Payment Tracker SSO affiliated application will be used for the MQSeries Adapter and the mapped external user ID/password are sent through MQSeries header properties.</span></span> <span data-ttu-id="ecb97-388">MQSeries Server valida sólo la cuenta de servicio de BizTalk con la que se está ejecutando el adaptador de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-388">The MQSeries Server validates only the BizTalk service account, under which MQSeries Adapter is running.</span></span> <span data-ttu-id="ecb97-389">No valida ninguna credencial de usuario externo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-389">It doesn't validate any external user credential.</span></span>  
    >   
    >  <span data-ttu-id="ecb97-390">Para obtener más información acerca de SSO afiliadas aplicaciones para el adaptador de MQSeries, vea [cómo configurar ubicaciones de recepción de MQSeries adaptador y puertos de envío](../core/how-to-configure-mqseries-adapter-receive-locations-and-send-ports.md).</span><span class="sxs-lookup"><span data-stu-id="ecb97-390">For more information about SSO affiliated applications for the MQSeries Adapter, see [How to Configure MQSeries Adapter Receive Locations and Send Ports](../core/how-to-configure-mqseries-adapter-receive-locations-and-send-ports.md).</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-391">El archivo PmntTrckUserMap.xml contiene las asignaciones de usuario SSO para el sistema de servidor de seguimiento de pago.</span><span class="sxs-lookup"><span data-stu-id="ecb97-391">The PmntTrckUserMap.xml file contains the SSO user mappings for the Payment Tracker back-end system.</span></span> <span data-ttu-id="ecb97-392">El programa de simulador de seguimiento de pago simula las condiciones de acierto y error de la autenticación de usuarios.</span><span class="sxs-lookup"><span data-stu-id="ecb97-392">The Payment Tracker simulator program simulates both success and failure conditions for user authentication.</span></span>  
    >   
    >  <span data-ttu-id="ecb97-393">El programa autentica correctamente todos los identificadores de usuario que comienzan con las letras **PT** (por ejemplo, **PTUserID**) pero no puede autenticar los identificadores que no comienzan por usuario **PT**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-393">The program successfully authenticates all user IDs that begin with the letters **PT** (for example, **PTUserID**), and fails to authenticate any user IDs that do not begin with **PT**.</span></span> <span data-ttu-id="ecb97-394">Esto permite elegir el Id. de usuario correcto según la condición que desee probar.</span><span class="sxs-lookup"><span data-stu-id="ecb97-394">This enables you to choose the appropriate user ID depending on the condition that you would like to test.</span></span> <span data-ttu-id="ecb97-395">También puede repetir todo el **asignación** nodo para cada identificador de usuario y definir varias asignaciones en el mismo archivo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-395">You can also repeat the entire **mapping** node for each user ID and define multiple mappings in the same file.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-396">Para el **externalUserId** nodo, escriba el identificador de usuario externo para el sistema de back-end de seguimiento de pago.</span><span class="sxs-lookup"><span data-stu-id="ecb97-396">For the **externalUserId** node, enter the external user ID for the Payment Tracker back-end system.</span></span> <span data-ttu-id="ecb97-397">Para este tutorial, utilice PTUserID como identificador externo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-397">For this walkthrough, use PTUserID for the external ID.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-398">Para el **windowsUserId** nodo, escriba el usuario que el nombre del **externalUserId** se asignarán a.</span><span class="sxs-lookup"><span data-stu-id="ecb97-398">For the **windowsUserId** node, enter the user name which the **externalUserId** will map to.</span></span> <span data-ttu-id="ecb97-399">El usuario debe ser miembro del grupo al que se permitirá utilizar el sistema de servidor de seguimiento de pago.</span><span class="sxs-lookup"><span data-stu-id="ecb97-399">This user must be a member of the group that will be allowed to use the Payment Tracker back-end system.</span></span> <span data-ttu-id="ecb97-400">En este tutorial, utilice el nombre de usuario del servicio de BizTalk.</span><span class="sxs-lookup"><span data-stu-id="ecb97-400">For this walkthrough, use the user name of the BizTalk service.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-401">Para el **windowsDomain** nodo, escriba el nombre de dominio de la **windowsUserId**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-401">For the **windowsDomain** node, enter the domain name of the **windowsUserId**.</span></span>  
  
6.  <span data-ttu-id="ecb97-402">En el símbolo del sistema, abra el archivo ConfigStoreApp.xml con el Bloc de notas y, a continuación, analice su contenido.</span><span class="sxs-lookup"><span data-stu-id="ecb97-402">At the command prompt, open the ConfigStoreApp.xml file using Notepad, and then review the contents of the file.</span></span>  
  
     <span data-ttu-id="ecb97-403">Este archivo define la aplicación de almacenamiento de configuración de SSO que el escenario emplea para mantener los parámetros de configuración.</span><span class="sxs-lookup"><span data-stu-id="ecb97-403">This file defines the configuration store application in SSO that the scenario uses to keep configuration parameters.</span></span> <span data-ttu-id="ecb97-404">Entre los parámetros de configuración, se encuentra el valor de tiempo de espera para la comunicación con SAP (tanto para la versión en línea como para la de adaptador), el nombre del administrador de cola y las colas que se emplearán al utilizar la versión en línea.</span><span class="sxs-lookup"><span data-stu-id="ecb97-404">Some of the configuration parameters include the Timeout value when communicating with SAP (for both the adapter and inline versions) and the name of the queue manager and queues to use when using the inline version.</span></span> <span data-ttu-id="ecb97-405">No es necesario realizar cambios en este archivo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-405">No changes to this file are necessary.</span></span>  
  
7.  <span data-ttu-id="ecb97-406">En el símbolo del sistema, abra el archivo SetConfigValuesInSSO.cmd con el Bloc de notas y revise y cambie su contenido de acuerdo con los valores de la tabla siguiente.</span><span class="sxs-lookup"><span data-stu-id="ecb97-406">At the command prompt, open the SetConfigValuesInSSO.cmd file using Notepad, review and change the contents of the file as the following table.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-407">Este archivo de comandos establece los valores de los parámetros de configuración de la base de datos de SSO.</span><span class="sxs-lookup"><span data-stu-id="ecb97-407">This command file sets the values for the configuration parameters in the SSO database.</span></span> <span data-ttu-id="ecb97-408">Contiene varios comandos establecidos que asignan valores a variables locales al principio del archivo de comandos.</span><span class="sxs-lookup"><span data-stu-id="ecb97-408">It contains several set commands that assign the values to local variables in the beginning of the command file.</span></span>  
    >   
    >  <span data-ttu-id="ecb97-409">Los valores SAPAdapterTimeout, PendingTransactionsAdapterTimeout y PaymentTrackingAdapterTimeout se utilizan en la versión de adaptador.</span><span class="sxs-lookup"><span data-stu-id="ecb97-409">The SAPAdapterTimeout, PendingTransactionsAdapterTimeout, and PaymentTrackingAdapterTimeout values are used in the adapter version.</span></span> <span data-ttu-id="ecb97-410">Los valores restantes se utilizan en la versión en línea.</span><span class="sxs-lookup"><span data-stu-id="ecb97-410">The remaining values are used in the inline version.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-411">Puede escribir "" (dos comillas dobles) para los valores predeterminados marcados \<especificado por el usuario\> en la tabla siguiente.</span><span class="sxs-lookup"><span data-stu-id="ecb97-411">You can enter " " (two double quotes) for the default values marked \<User Specified\> in the following table.</span></span>  
  
    |<span data-ttu-id="ecb97-412">Parámetro</span><span class="sxs-lookup"><span data-stu-id="ecb97-412">Parameter</span></span>|<span data-ttu-id="ecb97-413">Valor predeterminado</span><span class="sxs-lookup"><span data-stu-id="ecb97-413">Default Value</span></span>|<span data-ttu-id="ecb97-414">Description</span><span class="sxs-lookup"><span data-stu-id="ecb97-414">Description</span></span>|  
    |---------------|-------------------|-----------------|  
    |<span data-ttu-id="ecb97-415">SAPAdapterTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-415">SAPAdapterTimeout</span></span>|<span data-ttu-id="ecb97-416">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-416">20000</span></span>|<span data-ttu-id="ecb97-417">Tiempo máximo de espera (en milisegundos) de una solicitud al back-end SAP</span><span class="sxs-lookup"><span data-stu-id="ecb97-417">Max timeout (millisecond) for a request to the SAP back-end</span></span>|  
    |<span data-ttu-id="ecb97-418">SAPInlineTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-418">SAPInlineTimeout</span></span>|<span data-ttu-id="ecb97-419">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-419">20000</span></span>|<span data-ttu-id="ecb97-420">Tiempo máximo de espera (en milisegundos) de una solicitud al back-end SAP</span><span class="sxs-lookup"><span data-stu-id="ecb97-420">Max timeout (millisecond) for a request to the SAP back-end</span></span>|  
    |<span data-ttu-id="ecb97-421">SAPInlineHostName</span><span class="sxs-lookup"><span data-stu-id="ecb97-421">SAPInlineHostName</span></span>|<span data-ttu-id="ecb97-422">\<Especificado por el usuario\></span><span class="sxs-lookup"><span data-stu-id="ecb97-422">\<User Specified\></span></span>|<span data-ttu-id="ecb97-423">Identificador de servidor SAP</span><span class="sxs-lookup"><span data-stu-id="ecb97-423">SAP back-end identifier</span></span>|  
    |<span data-ttu-id="ecb97-424">SAPInlineClientNumber</span><span class="sxs-lookup"><span data-stu-id="ecb97-424">SAPInlineClientNumber</span></span>|<span data-ttu-id="ecb97-425">\<Especificado por el usuario\></span><span class="sxs-lookup"><span data-stu-id="ecb97-425">\<User Specified\></span></span>|<span data-ttu-id="ecb97-426">Número de cliente SAP</span><span class="sxs-lookup"><span data-stu-id="ecb97-426">SAP Client number</span></span>|  
    |<span data-ttu-id="ecb97-427">SAPInlineSystemNumber</span><span class="sxs-lookup"><span data-stu-id="ecb97-427">SAPInlineSystemNumber</span></span>|<span data-ttu-id="ecb97-428">\<Especificado por el usuario\></span><span class="sxs-lookup"><span data-stu-id="ecb97-428">\<User Specified\></span></span>|<span data-ttu-id="ecb97-429">Número de sistema SAP</span><span class="sxs-lookup"><span data-stu-id="ecb97-429">SAP System number</span></span>|  
    |<span data-ttu-id="ecb97-430">SAPInlineUserName</span><span class="sxs-lookup"><span data-stu-id="ecb97-430">SAPInlineUserName</span></span>|<span data-ttu-id="ecb97-431">\<Especificado por el usuario\></span><span class="sxs-lookup"><span data-stu-id="ecb97-431">\<User Specified\></span></span>|<span data-ttu-id="ecb97-432">Nombre de usuario utilizado para conectarse al servidor SAP.</span><span class="sxs-lookup"><span data-stu-id="ecb97-432">The user name used to connect to the SAP back-end</span></span>|  
    |<span data-ttu-id="ecb97-433">SAPInlinePassword</span><span class="sxs-lookup"><span data-stu-id="ecb97-433">SAPInlinePassword</span></span>|<span data-ttu-id="ecb97-434">\<Especificado por el usuario\></span><span class="sxs-lookup"><span data-stu-id="ecb97-434">\<User Specified\></span></span>|<span data-ttu-id="ecb97-435">Contraseña utilizada para conectarse al servidor SAP.</span><span class="sxs-lookup"><span data-stu-id="ecb97-435">The password used to connect to the SAP back-end</span></span>|  
    |<span data-ttu-id="ecb97-436">PendingTransactionsAdapterTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-436">PendingTransactionsAdapterTimeout</span></span>|<span data-ttu-id="ecb97-437">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-437">20000</span></span>|<span data-ttu-id="ecb97-438">Tiempo máximo de espera (en milisegundos) para una solicitud al servidor de transacciones pendientes</span><span class="sxs-lookup"><span data-stu-id="ecb97-438">Max timeout (millisecond) for a request to the Pending Transactions server</span></span>|  
    |<span data-ttu-id="ecb97-439">PendingTransactionsInlineTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-439">PendingTransactionsInlineTimeout</span></span>|<span data-ttu-id="ecb97-440">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-440">20000</span></span>|<span data-ttu-id="ecb97-441">Tiempo máximo de espera (en milisegundos) para una solicitud al servidor de transacciones pendientes</span><span class="sxs-lookup"><span data-stu-id="ecb97-441">Max timeout (millisecond) for a request to the Pending Transactions server</span></span>|  
    |<span data-ttu-id="ecb97-442">PendingTransactionsInlineURL</span><span class="sxs-lookup"><span data-stu-id="ecb97-442">PendingTransactionsInlineURL</span></span>|<span data-ttu-id="ecb97-443">https://\<*el nombre del equipo*\>/Microsoft.Samples.BizTalk.WoodgroveBank.PendingTransactions/PendTransWS.asmx</span><span class="sxs-lookup"><span data-stu-id="ecb97-443">https://\<*your computer name*\>/Microsoft.Samples.BizTalk.WoodgroveBank.PendingTransactions/PendTransWS.asmx</span></span>|<span data-ttu-id="ecb97-444">Dirección URL del servicio transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-444">URL of the Pending Transactions service.</span></span> <span data-ttu-id="ecb97-445">\<*El nombre del equipo* \> debe coincidir con el **nombre común** en el procedimiento "para crear una solicitud de certificado".</span><span class="sxs-lookup"><span data-stu-id="ecb97-445">\<*Your computer name*\> must match the **common name** in the procedure "To create a certificate request".</span></span> <span data-ttu-id="ecb97-446">No debe utilizar "localhost" para \< *el nombre del equipo*\>.</span><span class="sxs-lookup"><span data-stu-id="ecb97-446">You must not use "localhost" for \<*Your computer name*\>.</span></span>|  
    |<span data-ttu-id="ecb97-447">PendingTransactionsInlineSSOAffiliateApp</span><span class="sxs-lookup"><span data-stu-id="ecb97-447">PendingTransactionsInlineSSOAffiliateApp</span></span>|<span data-ttu-id="ecb97-448">WoodgroveBank.PendingTransactions</span><span class="sxs-lookup"><span data-stu-id="ecb97-448">WoodgroveBank.PendingTransactions</span></span>|<span data-ttu-id="ecb97-449">Nombre de la aplicación SSO de transacciones pendientes</span><span class="sxs-lookup"><span data-stu-id="ecb97-449">Pending Transactions SSO application name</span></span>|  
    |<span data-ttu-id="ecb97-450">PaymentTrackingAdapterTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-450">PaymentTrackingAdapterTimeout</span></span>|<span data-ttu-id="ecb97-451">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-451">20000</span></span>|<span data-ttu-id="ecb97-452">Tiempo máximo de espera (en milisegundos) para una solicitud al sistema seguimiento de pagos</span><span class="sxs-lookup"><span data-stu-id="ecb97-452">Max timeout (millisecond) for a request to the Payment Tracking system</span></span>|  
    |<span data-ttu-id="ecb97-453">PaymentTrackingInlineTimeout</span><span class="sxs-lookup"><span data-stu-id="ecb97-453">PaymentTrackingInlineTimeout</span></span>|<span data-ttu-id="ecb97-454">20000</span><span class="sxs-lookup"><span data-stu-id="ecb97-454">20000</span></span>|<span data-ttu-id="ecb97-455">Tiempo máximo de espera (en milisegundos) para una solicitud al sistema seguimiento de pagos</span><span class="sxs-lookup"><span data-stu-id="ecb97-455">Max timeout (millisecond) for a request to the Payment Tracking system</span></span>|  
    |<span data-ttu-id="ecb97-456">PaymentTrackingInlineQManager</span><span class="sxs-lookup"><span data-stu-id="ecb97-456">PaymentTrackingInlineQManager</span></span>|<span data-ttu-id="ecb97-457">\<Usuario Specified\> (normalmente QM_\<*el nombre del equipo*\>).</span><span class="sxs-lookup"><span data-stu-id="ecb97-457">\<User Specified\> (Typically QM_\<*your computer name*\>).</span></span>|<span data-ttu-id="ecb97-458">Nombre del administrador de la cola MQSeries</span><span class="sxs-lookup"><span data-stu-id="ecb97-458">MQSeries Queue Manager name</span></span>|  
    |<span data-ttu-id="ecb97-459">PaymentTrackingInlineMQChannelDefinition</span><span class="sxs-lookup"><span data-stu-id="ecb97-459">PaymentTrackingInlineMQChannelDefinition</span></span>|<span data-ttu-id="ecb97-460">" " (es necesario escribir las dos comillas dobles).</span><span class="sxs-lookup"><span data-stu-id="ecb97-460">" " (need to enter the two double quotes).</span></span>|<span data-ttu-id="ecb97-461">Si es local, una cadena vacía, o bien el nombre del canal con formato del servidor MQ remoto.</span><span class="sxs-lookup"><span data-stu-id="ecb97-461">Empty string if local, or formatted channel name of the remote MQ server.</span></span> <span data-ttu-id="ecb97-462">Si mantiene todos los valores predeterminados en la configuración de IBM WebSphere MQ, la definición de canal será S__\<*el nombre del equipo*\>/TCP /\<*el nombre del equipo* \>(1414).</span><span class="sxs-lookup"><span data-stu-id="ecb97-462">If you keep all default settings in configuring IBM WebSphere MQ, the channel definition will be S__\<*your computer name*\>/TCP/\<*your computer name*\>(1414).</span></span>|  
    |<span data-ttu-id="ecb97-463">PaymentTrackingInlineRequestQueue</span><span class="sxs-lookup"><span data-stu-id="ecb97-463">PaymentTrackingInlineRequestQueue</span></span>|<span data-ttu-id="ecb97-464">LastPaymentsInputQueue</span><span class="sxs-lookup"><span data-stu-id="ecb97-464">LastPaymentsInputQueue</span></span>|<span data-ttu-id="ecb97-465">Nombre de la cola MQ para las solicitudes de seguimiento de pago</span><span class="sxs-lookup"><span data-stu-id="ecb97-465">The MQ Queue name for payment tracking requests</span></span>|  
    |<span data-ttu-id="ecb97-466">PaymentTrackingInlineResponseQueue</span><span class="sxs-lookup"><span data-stu-id="ecb97-466">PaymentTrackingInlineResponseQueue</span></span>|<span data-ttu-id="ecb97-467">LastPaymentsOutputQueue</span><span class="sxs-lookup"><span data-stu-id="ecb97-467">LastPaymentsOutputQueue</span></span>|<span data-ttu-id="ecb97-468">Nombre de la cola MQ para respuestas de seguimiento de pago</span><span class="sxs-lookup"><span data-stu-id="ecb97-468">The MQ Queue name for payment tracking responses</span></span>|  
    |<span data-ttu-id="ecb97-469">PaymentTrackingInlineSSOAffiliateApp</span><span class="sxs-lookup"><span data-stu-id="ecb97-469">PaymentTrackingInlineSSOAffiliateApp</span></span>|<span data-ttu-id="ecb97-470">WoodgroveBank.PaymentTracker</span><span class="sxs-lookup"><span data-stu-id="ecb97-470">WoodgroveBank.PaymentTracker</span></span>|<span data-ttu-id="ecb97-471">Nombre de la aplicación SSO de seguimiento de pago</span><span class="sxs-lookup"><span data-stu-id="ecb97-471">Payment tracking SSO application name</span></span>|  
    |<span data-ttu-id="ecb97-472">StubSAPWebServiceURL</span><span class="sxs-lookup"><span data-stu-id="ecb97-472">StubSAPWebServiceURL</span></span>|<span data-ttu-id="ecb97-473">http://localhost/Microsoft.Samples.BizTalk.WoodgroveBank.StubSAP/StubSAPWS.asmx</span><span class="sxs-lookup"><span data-stu-id="ecb97-473">http://localhost/Microsoft.Samples.BizTalk.WoodgroveBank.StubSAP/StubSAPWS.asmx</span></span>|<span data-ttu-id="ecb97-474">URL del servicio Web de código auxiliar del sistema SAP de límite de crédito</span><span class="sxs-lookup"><span data-stu-id="ecb97-474">The stub Web service URL of the Credit Limit SAP system</span></span>|  
  
8.  <span data-ttu-id="ecb97-475">En el símbolo del sistema, ejecute el siguiente comando establecer el entorno PATH:</span><span class="sxs-lookup"><span data-stu-id="ecb97-475">At the command prompt, run the following command to set the PATH environment:</span></span>  
  
    -   `SET PATH=%PATH%;"%CommonProgramFiles%\Enterprise Single Sign-On"`  
  
9. <span data-ttu-id="ecb97-476">En el símbolo del sistema, ejecute el CreateInitialConfigInSSO.cmd.</span><span class="sxs-lookup"><span data-stu-id="ecb97-476">At the command prompt, run the CreateInitialConfigInSSO.cmd.</span></span> <span data-ttu-id="ecb97-477">Crea las aplicaciones afiliadas de SSO, la aplicación de almacén de configuración de SSO y las asignaciones de usuario para las aplicaciones afiliadas.</span><span class="sxs-lookup"><span data-stu-id="ecb97-477">It creates the SSO Affiliate Applications, the SSO configuration store application, and the user mappings for the affiliate applications.</span></span> <span data-ttu-id="ecb97-478">A continuación, ejecuta SetConfigValuesInSSO.cmd para almacenar los valores de configuración en la aplicación de almacenamiento de la configuración SSO.</span><span class="sxs-lookup"><span data-stu-id="ecb97-478">Then, it executes the SetConfigValuesInSSO.cmd to store configuration values in the SSO configuration store application.</span></span>  
  
10. <span data-ttu-id="ecb97-479">En el símbolo del sistema, ejecute el comando siguiente para establecer la credencial de usuario de la aplicación afiliada de transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-479">At the command prompt, run the following command to set the user credential for the Pending Transactions affiliate application.</span></span> <span data-ttu-id="ecb97-480">Use la \< **DomainName** \> y \< **UserID** \> definido en el archivo PendTransUserMap.xml para el \<WindowsDomain\> \\< WindowsUserId\>.</span><span class="sxs-lookup"><span data-stu-id="ecb97-480">Use the \<**DomainName**\> and \<**UserID**\> defined in the PendTransUserMap.xml for the \<WindowsDomain\>\\<WindowsUserId\>.</span></span> <span data-ttu-id="ecb97-481">Este comando pide que facilite la contraseña del usuario externo, UserID, utilizado en este tutorial.</span><span class="sxs-lookup"><span data-stu-id="ecb97-481">This command asks you to enter the password of the external user, UserID, used in this walkthrough.</span></span>  
  
    -   `ssomanage -setcredentials <WindowsDomain>\<WindowsUserId> WoodgroveBank.PendingTransactions`  
  
11. <span data-ttu-id="ecb97-482">En el símbolo del sistema, ejecute el comando siguiente para establecer la credencial de usuario de la aplicación afiliada de seguimiento de pago.</span><span class="sxs-lookup"><span data-stu-id="ecb97-482">At the command prompt, run the following command to set the user credential for the Payment Tracker affiliate application.</span></span> <span data-ttu-id="ecb97-483">Use la \< **DomainName** \> y \< **UserID** \> definido en el archivo PmntTrckUserMap.xml para el \<WindowsDomain\> \\< WindowsUserId\>.</span><span class="sxs-lookup"><span data-stu-id="ecb97-483">Use the \<**DomainName**\> and \<**UserID**\> defined in the PmntTrckUserMap.xml for the \<WindowsDomain\>\\<WindowsUserId\>.</span></span> <span data-ttu-id="ecb97-484">Este comando pide que facilite la contraseña del usuario externo, PTUserID, utilizado en este tutorial.</span><span class="sxs-lookup"><span data-stu-id="ecb97-484">This command asks you to enter the password of the external user, PTUserID, used in this walkthrough.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-485">El simulador de seguimiento de pago no valida la credencia de usuario externo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-485">The Payment Tracker simulator doesn't validate the external user credential.</span></span> <span data-ttu-id="ecb97-486">Puede escribir cualquier contraseña para el identificador PTUserID.</span><span class="sxs-lookup"><span data-stu-id="ecb97-486">You can enter any password for the PTUserID.</span></span>  
  
    -   `ssomanage -setcredentials < WindowsDomain >\< WindowsUserId > WoodgroveBank.PaymentTracker`  
  
##  <a name="step19"></a><span data-ttu-id="ecb97-487">Implementar el archivo de definición de BAM para la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-487">Deploy the BAM definition file for the Service Oriented Solution</span></span>  
  
1.  <span data-ttu-id="ecb97-488">Abra un símbolo del sistema, escriba el comando siguiente y, a continuación, presione ENTRAR para establecer la ruta para buscar las utilidades de SAE:</span><span class="sxs-lookup"><span data-stu-id="ecb97-488">Open a command prompt, type the following command, and then press ENTER to set the path to find the BAM utilities:</span></span>  
  
    -   <span data-ttu-id="ecb97-489">SET PATH=%PATH%;[!INCLUDE[btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]Tracking"</span><span class="sxs-lookup"><span data-stu-id="ecb97-489">SET PATH=%PATH%;[!INCLUDE[btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]Tracking"</span></span>  
  
2.  <span data-ttu-id="ecb97-490">En el símbolo del sistema, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\BAM, escriba el comando siguiente y, a continuación, presione ENTRAR:</span><span class="sxs-lookup"><span data-stu-id="ecb97-490">At the command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln\BAM, type the following command, and then press ENTER:</span></span>  
  
    -   `bm deploy-all -DefinitionFile:ServiceLevelTracking.xml`  
  
##  <a name="step21"></a><span data-ttu-id="ecb97-491">Implementar solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-491">Deploy the Service Oriented Solution</span></span>  
  
#### <a name="update-the-binding-files-for-the-service-oriented-solution"></a><span data-ttu-id="ecb97-492">Actualizar los archivos de enlace para la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-492">Update the binding files for the Service Oriented Solution</span></span>  
  
1.  <span data-ttu-id="ecb97-493">En el símbolo del sistema, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\Scripts, abra el archivo Deployallbinding.xml en Notepad y, a continuación, realice las siguientes modificaciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-493">At a command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln\Scripts folder, open the Deployallbinding.xml using Notepad, and then make the following edits:</span></span>  
  
    -   <span data-ttu-id="ecb97-494">Cambie el nombre del servidor que aparece en SET MGMT_DB_SERVER y en MBMT_DB al nombre del servidor y de la base de datos que está utilizando BizTalk Server.</span><span class="sxs-lookup"><span data-stu-id="ecb97-494">Change the name of the server in the SET MGMT_DB_SERVER and MBMT_DB to the name of the server and database that BizTalk Server is using.</span></span>  
  
    -   <span data-ttu-id="ecb97-495">Cambie el valor de la variable SOLNDIR a "%BTSSolutionsPath%\SO\BTSSoln".</span><span class="sxs-lookup"><span data-stu-id="ecb97-495">Change the value of the SOLNDIR variable to "%BTSSolutionsPath%\SO\BTSSoln".</span></span>  
  
2.  <span data-ttu-id="ecb97-496">En un símbolo de sistema, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\Bindings.</span><span class="sxs-lookup"><span data-stu-id="ecb97-496">At a command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln\Bindings folder.</span></span>  
  
3.  <span data-ttu-id="ecb97-497">Para la versión de adaptador, abra el archivo AdapterSOAOrchBindings.xml con el Bloc de notas y, a continuación, realice las siguientes modificaciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-497">For the adapter version, open the AdapterSOAOrchBindings.xml using Notepad, and then edit as follows:</span></span>  
  
    -   <span data-ttu-id="ecb97-498">Reemplace todas las apariciones de __MQ_SERVER_NAME\_ \_ con el nombre del servidor de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-498">Replace all occurrences of __MQ_SERVER_NAME\_\_ with the MQSeries Server name.</span></span>  
  
    -   <span data-ttu-id="ecb97-499">Reemplace todas las apariciones de __MQ_QMANAGER_NAME\_ \_ con el nombre del Administrador de cola de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-499">Replace all occurrences of __MQ_QMANAGER_NAME\_\_ with the MQSeries Queue Manager name.</span></span>  
  
    -   <span data-ttu-id="ecb97-500">Reemplace todas las apariciones de __PT_WS_SERVER_NAME\_ \_ en la cadena "\<dirección\>https://\__PT_WS_SERVER_NAME\_\_" con el nombre del servidor donde la pendiente Se implementa el servicio Web de transacciones.</span><span class="sxs-lookup"><span data-stu-id="ecb97-500">Replace all occurrences of __PT_WS_SERVER_NAME\_\_ in the string "\<Address\>https://\__PT_WS_SERVER_NAME\_\_" with the server name where the Pending Transactions Web service is deployed.</span></span> <span data-ttu-id="ecb97-501">El nombre del servidor debe coincidir con el **nombre común** en el paso "para configurar el servidor Web para SSL".</span><span class="sxs-lookup"><span data-stu-id="ecb97-501">The server name must match the **common name** in the step, "To configure the Web server for SSL".</span></span> <span data-ttu-id="ecb97-502">No debe utilizar localhost.</span><span class="sxs-lookup"><span data-stu-id="ecb97-502">You shouldn't use localhost.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-503">El archivo de enlace, AdapterSOAOrchBindings.xml, emplea el servicio Web de código auxiliar para las siguientes funciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-503">The binding file, AdapterSOAOrchBindings.xml, uses the stub Web service for:</span></span>  
    >   
    >  1.  <span data-ttu-id="ecb97-504">El sistema de back-end SAP de límite de crédito.</span><span class="sxs-lookup"><span data-stu-id="ecb97-504">The Credit Limit back-end SAP system.</span></span>  
    > 2.  <span data-ttu-id="ecb97-505">El adaptador de MQSeries para integrarse con el sistema de back-end de seguimiento de pagos.</span><span class="sxs-lookup"><span data-stu-id="ecb97-505">The MQSeries adapter to integrate with the Payment Tracking back-end system.</span></span>  
    > 3.  <span data-ttu-id="ecb97-506">El servicio web de transacciones pendientes para realizar la llamada al componente .NET TI de HIS y realizar la integración con el sistema de back-end de mainframe.</span><span class="sxs-lookup"><span data-stu-id="ecb97-506">The Pending Transactions Web service to call the HIS TI .NET component to integrate with the mainframe back-end system.</span></span>  
    >   
    >  <span data-ttu-id="ecb97-507">Si no está utilizando un sistema mainframe, deberá emplear el servicio Web de código auxiliar para generar datos para el sistema de transacciones pendientes.</span><span class="sxs-lookup"><span data-stu-id="ecb97-507">If you aren’t using the mainframe, you must use the stub Web service to generate data for the Pending Transactions system.</span></span>  
  
4.  <span data-ttu-id="ecb97-508">Para la versión en línea, abra el archivo InlineSOAOrchBindings.xml con el Bloc de notas y, a continuación, realice las siguientes modificaciones:</span><span class="sxs-lookup"><span data-stu-id="ecb97-508">For the inline version, open the InlineSOAOrchBindings.xml using Notepad, and then edit as follows:</span></span>  
  
    -   <span data-ttu-id="ecb97-509">Reemplace todas las apariciones de __MQ_SERVER_NAME\_ \_ con el nombre del servidor de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-509">Replace all occurrences of __MQ_SERVER_NAME\_\_ with the MQSeries Server name.</span></span>  
  
    -   <span data-ttu-id="ecb97-510">Reemplace todas las apariciones de __MQ_QMANAGER_NAME\_ \_ con el nombre del Administrador de cola de MQSeries.</span><span class="sxs-lookup"><span data-stu-id="ecb97-510">Replace all occurrences of __MQ_QMANAGER_NAME\_\_ with the MQSeries Queue Manager name.</span></span>  
  
#### <a name="deploy-the-service-oriented-solution"></a><span data-ttu-id="ecb97-511">Implementar la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-511">Deploy the Service Oriented solution</span></span>  
  
-   <span data-ttu-id="ecb97-512">En un símbolo del sistema, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\Scripts, escriba el comando siguiente y, a continuación, presione ENTRAR:</span><span class="sxs-lookup"><span data-stu-id="ecb97-512">At a command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln\Scripts folder, type the following command, and then press ENTER.</span></span>  
  
    -   `Deployallbinding.cmd`  
  
    > [!NOTE]
    >  <span data-ttu-id="ecb97-513">El comando Deployallbinding.cmd crea una aplicación de BizTalk denominada BTSScn.SO.CustomerService e importa archivos de enlace para las versiones de adaptador y en línea.</span><span class="sxs-lookup"><span data-stu-id="ecb97-513">The Deployallbinding.cmd creates the BizTalk application named BTSScn.SO.CustomerService and imports binding files for the adapter and inline versions.</span></span>  
  
##  <a name="step23"></a><span data-ttu-id="ecb97-514">Configurar el código auxiliar de servicios Web de transacciones pendientes cuando no hay un gran sistema</span><span class="sxs-lookup"><span data-stu-id="ecb97-514">Configure the stub Pending Transactions Web Services when a mainframe is not available</span></span>  
  
#### <a name="configure-the-stub-pending-transactions-web-service-for-using-the-adapter-version-without-a-mainframe"></a><span data-ttu-id="ecb97-515">Configurar el servicio Web de transacciones pendientes (para utilizar la versión del adaptador sin un gran sistema) de código auxiliar</span><span class="sxs-lookup"><span data-stu-id="ecb97-515">Configure the stub Pending Transactions Web service (for using the adapter version without a mainframe)</span></span>  
  
1.  <span data-ttu-id="ecb97-516">En el **Internet Information Services (IIS) Manager**, expanda **sitios Web**, haga clic en el **sitio Web predeterminado**, seleccione **nuevo**, y a continuación, haga clic en **directorio Virtual** para ejecutar **Asistente para crear un directorio Virtual**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-516">In the **Internet Information Services (IIS) Manager**, expand **Web Sites**, right-click the **Default Web Site**, point to **New**, and then click **Virtual Directory** to run **Virtual Directory Creation Wizard**.</span></span>  
  
     <span data-ttu-id="ecb97-517">Mediante el **Asistente para crear un directorio Virtual**, cree el siguiente directorio virtual para el servicio Web de transacciones pendientes para la versión del adaptador de código auxiliar:</span><span class="sxs-lookup"><span data-stu-id="ecb97-517">Using the **Virtual Directory Creation Wizard**, create the following virtual directory for stub Pending Transactions Web service for the adapter version:</span></span>  
  
     <span data-ttu-id="ecb97-518">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions</span><span class="sxs-lookup"><span data-stu-id="ecb97-518">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions</span></span>  
  
     <span data-ttu-id="ecb97-519">Ruta de acceso = \< *directorio de instalación de BizTalk*\>\SDK\Scenarios\SO\BTSSoln\StubWebServices\PendingTrans</span><span class="sxs-lookup"><span data-stu-id="ecb97-519">PATH = \<*BizTalk Install Directory*\>\SDK\Scenarios\SO\BTSSoln\StubWebServices\PendingTrans</span></span>  
  
     <span data-ttu-id="ecb97-520">Permisos de acceso = lectura, ejecución de scripts</span><span class="sxs-lookup"><span data-stu-id="ecb97-520">Access Permissions = Read, Run scripts</span></span>  
  
2.  <span data-ttu-id="ecb97-521">En el **Internet Information Services (IIS) Manager**, expanda **sitios Web**, expanda la **sitio Web predeterminado**, haga clic en Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions, haga clic en **propiedades**y, a continuación, modifique la configuración como se indica a continuación mediante el **propiedades** cuadro de diálogo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-521">In the **Internet Information Services (IIS) Manager**, expand **Web Sites**, expand the **Default Web Site**, right-click Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions, click **Properties**, and then modify the settings as follows using the **Properties** dialog box.</span></span>  
  
    1.  <span data-ttu-id="ecb97-522">En el **directorio Virtual** pestaña, establezca el **grupo de aplicaciones** a \< *YourAppPool* \> que creó en el paso "para crear el virtual directorios de IIS para la solución".</span><span class="sxs-lookup"><span data-stu-id="ecb97-522">In the **Virtual directory** tab, set the **Application Pool** to \<*YourAppPool*\> you created in the step, "To create the virtual directories in IIS for the solution".</span></span>  
  
    2.  <span data-ttu-id="ecb97-523">En el **seguridad de directorios** , haga clic en **editar** en el **autenticación y control de acceso** cuadro del grupo y, a continuación, seleccione **habilitar el acceso anónimo**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-523">In the **Directory Security** tab, click **Edit** in the **Authentication and access control** group box, and then select **Enable anonymous access**.</span></span> <span data-ttu-id="ecb97-524">Haga clic en **Aceptar** para salir.</span><span class="sxs-lookup"><span data-stu-id="ecb97-524">Click **OK** to exit.</span></span>  
  
3.  <span data-ttu-id="ecb97-525">En el **consola de administración de BizTalk Server**, expanda **grupo de BizTalk**, expanda **aplicaciones**, expanda y BTSScn.SO.CustomerService **enviar Puertos**, haga clic en **PendingTransactionSolicitResponsePort**y, a continuación, haga clic en **propiedades**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-525">In the **BizTalk Server Administration Console**, expand **BizTalk Group**, expand **Applications**, expand BTSScn.SO.CustomerService, expand **Send Ports**, right-click **PendingTransactionSolicitResponsePort**, and then click **Properties**.</span></span>  
  
    1.  <span data-ttu-id="ecb97-526">En el **General** página, haga clic en **configurar** para mostrar la **propiedades de transporte** diálogo cuadro y, a continuación, modifique la **dirección URL del servicio Web** a el servicio de código auxiliar Web de transacciones pendientes, por ejemplo:</span><span class="sxs-lookup"><span data-stu-id="ecb97-526">In the **General** page, click **Configure** to display the **Transport Properties** dialog box, and then modify the **Web Service URL** to the stub Pending Transaction Web service, for example:</span></span>  
  
         `http://localhost/Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions/StubPendTransWS.asmx`  
  
    2.  <span data-ttu-id="ecb97-527">Cierre todos los cuadros de diálogo.</span><span class="sxs-lookup"><span data-stu-id="ecb97-527">Close all of the dialog boxes.</span></span>  
  
#### <a name="configure-the-stub-pending-transactions-web-service-for-using-the-inline-version-without-a-mainframe"></a><span data-ttu-id="ecb97-528">Configurar el servicio Web de transacciones pendientes (para utilizar la versión en línea sin un gran sistema) de código auxiliar</span><span class="sxs-lookup"><span data-stu-id="ecb97-528">Configure the stub Pending Transactions Web service (for using the inline version without a mainframe)</span></span>  
  
1.  <span data-ttu-id="ecb97-529">En el **Internet Information Services (IIS) Manager**, expanda **sitios Web**, haga clic en el **sitio Web predeterminado**, seleccione **nuevo**, y a continuación, haga clic en **directorio Virtual** para ejecutar **Asistente para crear un directorio Virtual**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-529">In the **Internet Information Services (IIS) Manager**, expand **Web Sites**, right-click the **Default Web Site**, point to **New**, and then click **Virtual Directory** to run **Virtual Directory Creation Wizard**.</span></span>  
  
     <span data-ttu-id="ecb97-530">Mediante el **Asistente para crear un directorio Virtual**, cree el siguiente directorio virtual para el servicio Web de transacciones pendientes para la versión del adaptador de código auxiliar:</span><span class="sxs-lookup"><span data-stu-id="ecb97-530">Using the **Virtual Directory Creation Wizard**, create the following virtual directory for stub Pending Transactions Web service for the adapter version:</span></span>  
  
     <span data-ttu-id="ecb97-531">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions</span><span class="sxs-lookup"><span data-stu-id="ecb97-531">Alias = Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions</span></span>  
  
     <span data-ttu-id="ecb97-532">Ruta de acceso = \< *directorio de instalación de BizTalk*\>\SDK\Scenarios\SO\BTSSoln\StubWebServices\PendingTrans</span><span class="sxs-lookup"><span data-stu-id="ecb97-532">PATH = \<*BizTalk Install Directory*\>\SDK\Scenarios\SO\BTSSoln\StubWebServices\PendingTrans</span></span>  
  
     <span data-ttu-id="ecb97-533">Permisos de acceso = lectura, ejecución de scripts</span><span class="sxs-lookup"><span data-stu-id="ecb97-533">Access Permissions = Read, Run scripts</span></span>  
  
2.  <span data-ttu-id="ecb97-534">En el **Internet Information Services (IIS) Manager**, expanda **sitios Web**, expanda la **sitio Web predeterminado**, haga clic en Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions, haga clic en **propiedades**y, a continuación, modifique la configuración tal y como sigue:</span><span class="sxs-lookup"><span data-stu-id="ecb97-534">In the **Internet Information Services (IIS) Manager**, expand **Web Sites**, expand the **Default Web Site**, right-click Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions, click **Properties**, and then modify the settings as follows:</span></span>  
  
    1.  <span data-ttu-id="ecb97-535">En el **directorio Virtual** pestaña, establezca el **grupo de aplicaciones** a \< *YourAppPool* \> que creó en el paso "para crear el virtual directorios de IIS para la solución".</span><span class="sxs-lookup"><span data-stu-id="ecb97-535">In the **Virtual directory** tab, set the **Application Pool** to \<*YourAppPool*\> you created in the step, "To create the virtual directories in IIS for the solution".</span></span>  
  
    2.  <span data-ttu-id="ecb97-536">En el **seguridad de directorios** , haga clic en **editar** en el **autenticación y control de acceso** cuadro del grupo y, a continuación, seleccione **habilitar el acceso anónimo**.</span><span class="sxs-lookup"><span data-stu-id="ecb97-536">In the **Directory Security** tab, click **Edit** in the **Authentication and access control** group box, and then select **Enable anonymous access**.</span></span> <span data-ttu-id="ecb97-537">Haga clic en **Aceptar** para salir.</span><span class="sxs-lookup"><span data-stu-id="ecb97-537">Click **OK** to exit.</span></span>  
  
3.  <span data-ttu-id="ecb97-538">Abra un símbolo del sistema y, a continuación, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\Scripts.</span><span class="sxs-lookup"><span data-stu-id="ecb97-538">Open a command prompt, and then change the directory to the %BTSSolutionsPath%\SO\BTSSoln\Scripts folder.</span></span>  
  
4.  <span data-ttu-id="ecb97-539">En el símbolo del sistema, abra el archivo SetConfigValuesInSSO.cmd con el Bloc de notas y, a continuación, establezca el valor de la **PendingTransactionsInlineURL** a la dirección URL del servicio Web de transacción pendiente de código auxiliar.</span><span class="sxs-lookup"><span data-stu-id="ecb97-539">At the command prompt, open the SetConfigValuesInSSO.cmd file using Notepad, and then set the value of the **PendingTransactionsInlineURL** to the URL of the stub Pending Transaction Web Service.</span></span>  
  
    -   `http://localhost/Microsoft.Samples.BizTalk.WoodgroveBank.StubPendingTransactions/StubPendTransWS.asmx`  
  
5.  <span data-ttu-id="ecb97-540">En el símbolo del sistema, escriba `SetConfigValuesInSSO.cmd`, y, a continuación, presione ENTRAR.</span><span class="sxs-lookup"><span data-stu-id="ecb97-540">At the command prompt, type `SetConfigValuesInSSO.cmd`, and then press ENTER.</span></span>  
  
##  <a name="step25"></a><span data-ttu-id="ecb97-541">Inicie el servicio solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-541">Start the Service Oriented Solution</span></span>  
  
1.  <span data-ttu-id="ecb97-542">Abra un símbolo del sistema, cambie el directorio a la carpeta %BTSSolutionsPath%\SO\BTSSoln\Scripts, escriba el comando siguiente y, a continuación, presione ENTRAR para iniciar todas las orquestaciones de las versiones de adaptador y en línea.</span><span class="sxs-lookup"><span data-stu-id="ecb97-542">Open a command prompt, change the directory to the %BTSSolutionsPath%\SO\BTSSoln\Scripts folder, type the following command, and then press ENTER to start all orchestrations for the inline and adapter versions.</span></span>  
  
    -   `startAll.vbs`  
  
2.  <span data-ttu-id="ecb97-543">Ejecute la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-543">Run the service-oriented solution.</span></span> <span data-ttu-id="ecb97-544">Para obtener más información acerca de cómo ejecutar la solución, vea [cómo ejecutar la solución orientada a servicios](../core/how-to-run-the-service-oriented-solution.md).</span><span class="sxs-lookup"><span data-stu-id="ecb97-544">For more information about running the solution, see [How to Run the Service Oriented Solution](../core/how-to-run-the-service-oriented-solution.md).</span></span>  
  
## <a name="next-steps"></a><span data-ttu-id="ecb97-545">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="ecb97-545">Next Steps</span></span>  
 <span data-ttu-id="ecb97-546">Pruebe las versiones del adaptador y en línea de la solución orientada a servicios en [cómo ejecutar la solución orientada a servicios](../core/how-to-run-the-service-oriented-solution.md).</span><span class="sxs-lookup"><span data-stu-id="ecb97-546">You test the inline and adapter version of the service-oriented solution in [How to Run the Service Oriented Solution](../core/how-to-run-the-service-oriented-solution.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="ecb97-547">Vea también</span><span class="sxs-lookup"><span data-stu-id="ecb97-547">See Also</span></span>  
 <span data-ttu-id="ecb97-548">[Antes de instalar la solución orientada a servicios](../core/before-installing-the-service-oriented-solution.md) </span><span class="sxs-lookup"><span data-stu-id="ecb97-548">[Before Installing the Service Oriented Solution](../core/before-installing-the-service-oriented-solution.md) </span></span>  
 <span data-ttu-id="ecb97-549">[Cómo instalar la versión de código auxiliar del servicio en la solución orientada a servicios](../core/how-to-install-the-stub-version-of-the-service-oriented-solution.md) </span><span class="sxs-lookup"><span data-stu-id="ecb97-549">[How to Install the Stub Version of the Service Oriented Solution](../core/how-to-install-the-stub-version-of-the-service-oriented-solution.md) </span></span>  
 [<span data-ttu-id="ecb97-550">Configurar el equipo del desarrollador para la solución orientada a servicios</span><span class="sxs-lookup"><span data-stu-id="ecb97-550">Developer Machine Setup for the Service Oriented Solution</span></span>](../core/developer-machine-setup-for-the-service-oriented-solution.md)