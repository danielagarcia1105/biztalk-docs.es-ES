...
2. En el árbol de consola, expanda **administración de BizTalk Server**, expanda el grupo de BizTalk que contiene el esquema para el que desea ver la XSD y, a continuación, expanda la aplicación que contiene el esquema.  
