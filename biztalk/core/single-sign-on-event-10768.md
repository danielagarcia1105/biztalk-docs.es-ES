...
---
# <a name="single-sign-on-event-10768"></a>Inicio de sesión único: Evento 10768
...
|Identificador del evento|10768|  
|Origen del evento|ENTSSO|  
|Componente|N/D|  
|Nombre simbólico|ENTSSO_E_OUT_OF_SERVICE|  
|Texto del mensaje|Inicio de sesión único empresarial está desconectado.|  
  
## <a name="explanation"></a>Explicación  
 El sistema ENTSSO está desconectado.  
