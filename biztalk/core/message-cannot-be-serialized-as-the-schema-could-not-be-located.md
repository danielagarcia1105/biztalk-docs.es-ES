...
|Texto del mensaje|No se puede serializar el mensaje ya que el esquema {0} no ha podido localizarse. El esquema no está implementado o se han implementado varias copias.|  
