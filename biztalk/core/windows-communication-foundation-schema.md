...
---
# <a name="windows-communication-foundation-schema"></a>Esquema de Windows Communication Foundation
Esta sección contiene el esquema del interceptor de Windows Communication Framework.  
