...
1. Haga clic en **iniciar**, apunte a **todos los programas**, apunte a **herramientas administrativas**y, a continuación, haga clic en **Administración Central de SharePoint.**  
...
4. En el **dirección del sitio Web** sección la **nombre URL** , escriba `WSSAdapterWalkthrough`.  
  
5. En el **propietario de la colección de sitio** sección la **campo de nombre de usuario,** escriba un nombre de usuario. El usuario será el propietario del sitio web y no necesita permisos especiales para usar [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)].  
  
6. En el **propietario de la colección de sitio** sección la **correo electrónico** , escriba una dirección de correo electrónico.  
...
9. Seleccione el **Team Site** plantilla en la lista de plantillas y, a continuación, haga clic en **Aceptar**. De este modo se abre la página principal del sitio Web del equipo.  
...
3.  En el **nombre y descripción** sección la **campo nombre,** tipo `Source`.  
  
4.  En el **navegación** sección, seleccione **Sí** para mostrar esta biblioteca de formularios en la barra Inicio rápido.  
  
5.  En el **plantilla de documento** sección la **plantilla de documento** lista desplegable, seleccione `None`.  
...
3.  En el **nombre y descripción** sección la **campo nombre**, tipo `Destination`.  
...
6.  Haga clic en **servicio de BizTalk grupo: < BizTalk_Host_Name >** y, a continuación, haga clic en **reiniciar**.  
    ...
    > [!NOTE]
    >  <BizTalk_Host_Name> es el nombre del host. De forma predeterminada, se trata de `BizTalkServerApplication`.  
...
5. En **paso 1: elegir usuarios**, escriba el nombre de la cuenta que el [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] instancia de Host se está ejecutando bajo.  
  
6. En **paso 2: elegir grupos de sitio**, seleccione el **lector** y **colaborador** casillas de verificación.  
...
3.  En el **propiedades de ubicación de recepción** cuadro de diálogo **General**, tipo `SourceLocation` en el **nombre** campo.  
  
4.  En el **transporte** sección la **tipo** lista desplegable, seleccione `Windows``SharePoint``Services`.  
...
7.  Tipo `Archive` en el **ubicación de archivado** propiedad.  
  
8.  Tipo `10` en el **intervalo de sondeo** propiedad.  
  
9. Escriba la dirección URL al sitio de SharePoint en el **dirección**reconectarse propiedad de dirección Url del sitio. Por ejemplo, `http://<server_name>/sites/WSSAdapterWalkthrough`.  
  
10. Tipo `Source` para el **biblioteca de documentos de origen** propiedad.  
  
11. Haga clic en **Aceptar**.  
  
12. En el **propiedades de ubicación de recepción** cuadro de diálogo, seleccione `BizTalkServerApplication` como el **controlador de recepción**.  
...
8.  Establecer el **sobrescritura** propiedad `Yes`.  
  
9. Escriba la dirección URL al sitio de SharePoint en el **dirección Url del sitio de SharePoint** propiedad. Por ejemplo, `http://<server_name>/sites/WSSAdapterWalkthrough`.  
  
10. Establecer el **integración con Microsoft Office** propiedad `No`.  
  
11. Haga clic en **Aceptar**.  
  
12. En el **cuadro de diálogo Propiedades de puerto de envío**, en el **controlador de envío** lista desplegable, seleccione `BizTalkServerApplication`.  
...
17. Tipo `Source` en el **valor** campo.  
...
-   Cree un directorio en el equipo llamado **WSSAdapterWalkthrough**. Por ejemplo, `C:\WSSAdapterWalkthrough`.  
  
#### <a name="create-an-xml-file"></a>Crear un archivo XML.  
  
1.  Haga clic en **iniciar**, apunte a **todos los programas**, apunte a **Accesorios**y, a continuación, haga clic en **el Bloc de notas.**  
