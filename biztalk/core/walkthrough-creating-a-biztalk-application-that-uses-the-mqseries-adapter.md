...
5. Haga clic en **colas**, apunte a **New**y, a continuación, haga clic en **cola Local**.  
...
3.  En el **propiedades de puerto de recepción** cuadro de diálogo el **nombre** , escriba **MQStoBTS**.  
  
4.  En el panel izquierdo, haga clic en **ubicaciones de recepción**y en el panel derecho, haga clic en **New**.  
  
5.  En el **propiedades de ubicación de recepción** cuadro de diálogo el **nombre** , escriba **MQStoBTS**.  
...
8.  En el **propiedades de transporte MQSeries** cuadro de diálogo el **intervalo de sondeo** , escriba **1**.  
  
9. En el **definición de la cola** cuadro, haga clic en el botón de puntos suspensivos (**...** ) botón.  
  
10. En el **definición de la cola** cuadro de diálogo el **nombre del servidor** , escriba el nombre del equipo.  
...
13. En el **exportar** cuadro de diálogo, haga clic en **Create Queue**y, a continuación, haga clic en **Aceptar** y **Aceptar** para volver a la **recepción Propiedades de la ubicación** cuadro de diálogo.  
...
2.  En el **propiedades de puerto de envío** cuadro de diálogo el **nombre** , escriba **BTStoMQS.**  
...
5.  En el **propiedades de transporte MQSeries** cuadro de diálogo el **definición de la cola** cuadro, haga clic en el botón de puntos suspensivos (**...** ) botón.  
  
6.  En el **definición de la cola** cuadro de diálogo el **nombre del servidor** , escriba el nombre del equipo.  
...
9. En el **exportar** cuadro de diálogo, haga clic en **Create Queue**y, a continuación, haga clic en **Aceptar** y **Aceptar** para volver a la **puerto de envío Propiedades** cuadro de diálogo.  
...
3. En el **datos del mensaje** , escriba un mensaje de prueba. Haga clic en **Aceptar**.  
   ...
   Después de escribir los datos, el **Current Depth** para el **MQStoBTS** cola es uno (1). Cuando la aplicación procesa el mensaje, el recuento vuelve a cero (0) y el **Current Depth** para **BTStoMQS** se convierte en uno (1). También puede ver el contenido del mensaje.  
...
2.  Haga doble clic en el mensaje y, a continuación, seleccione el **datos** hoja. Puede ver el texto del mensaje en el **datos del mensaje** cuadro.  
