...
-   **Migrar un esquema desde un lenguaje de especificación de esquema anterior a XSD**. Puede generar un esquema XML para [!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)] desde un esquema que se desarrolló utilizando una versión anterior de BizTalk Server, que almacena los esquemas en formato de datos XML reducidos (XDR). Para obtener más información sobre cómo migrar esquemas XDR antiguos al formato XSD utilizado por [!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)], consulte [migración de esquemas de versiones anteriores de BizTalk Server](../core/schema-migration-from-previous-versions-of-biztalk-server.md).  
