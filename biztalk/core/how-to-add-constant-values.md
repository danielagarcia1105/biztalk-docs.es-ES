...
2.  En la ventana Propiedades, en la **General** categoría, use la **valor** propiedad para especificar un valor para el campo o registro seleccionado.  
 ...
 Para un nodo de esquema de origen, si establece la **valor** propiedad  **\<vacía >**, el mensaje de instancia generado para el esquema de origen contiene un valor vacío para el nodo respectivo.  
