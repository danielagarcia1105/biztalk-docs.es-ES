...
3.  Tipo de **ssoclient – server  *\<Single Sign-On Server >***, donde \< *Single Sign-On Server >* es el nombre de la Single Sign-On el usuario de servidor que va a conectar.  
