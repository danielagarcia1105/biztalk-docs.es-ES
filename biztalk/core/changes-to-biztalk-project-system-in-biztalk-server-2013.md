---
title: Los cambios en el sistema del proyecto de BizTalk en BizTalk Server 2013 | Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
ms.locfileid: "37003405"
---
# <a name="changes-to-biztalk-project-system-in-biztalk-server-2013"></a>Cambios realizados en el sistema del proyecto de BizTalk en BizTalk Server 2013
...
## <a name="properties-for-schema-and-map-files-are-displayed-in-properties-window"></a>Las propiedades para los archivos de esquema y de asignación se muestran en la ventana Propiedades.  
 Propiedades de los archivos de esquema y de asignación como **nombre de archivo de instancia de entrada** y **instancia de entrada de asignación de prueba** se muestran en la ventana Propiedades con en lugar de en otro **propiedades** cuadro de diálogo.  
...
1. Haga clic en **referencias** en el proyecto y, a continuación, haga clic en **Add Service Reference**.  
...
5. Haga clic en **Agregar referencia** para agregar la referencia Web.  
   ...
   > [!TIP]
   >  Después de agregar una referencia Web a un proyecto de BizTalk, el **Agregar referencia Web** opción de menú está disponible en las referencias, referencias Web y nodos de proyecto.  
...
## <a name="support-for-unit-testing"></a>Compatibilidad con pruebas unitarias  
 Esta característica permite probar unitariamente esquemas, mapas y canalizaciones. Para obtener más información, consulte [Unit Testing con proyectos de BizTalk Server](../core/unit-testing-with-biztalk-server-projects.md).  
  
## <a name="debug-map-feature"></a>Característica de depuración de asignación  
 **Característica de asignación de depuración**. Puede depurar una asignación (XSLT) usando el depurador XSLT en línea de [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)]. Para obtener más información, consulte [cómo depurar asignaciones](../core/how-to-debug-maps.md).  
...
## <a name="embedding-tracking-and-debugging-information"></a>Inserción de información de seguimiento y depuración  
 El **incrustar información de seguimiento** y **generar información de depuración** propiedades de configuración de salida se reemplazan por el **definir constante TRACE** y **Definir constante DEBUG** opciones de compilación el **compilar** ficha del Diseñador de proyectos. El **generación de código de cumplimiento de BPEL** propiedad de configuración se sustituye por **generación de código de cumplimiento de BPEL** propiedad en la ventana Propiedades del proyecto.  
