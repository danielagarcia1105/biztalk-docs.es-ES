...
ms.locfileid: "22241452"
---
# <a name="a-failure-occurred-in-processing-x12-message-on-send-port-no-agreement-for-receiver-and-sender-identifier-qualifier-pairs-and-no-party-with-name"></a>Se produjo un error en el procesamiento de X12 mensajes en el puerto de envío: no existen acuerdos de pares de calificador de identificador de destinatario y remitente y ninguna entidad con nombre
...
|Nombre simbólico|-|  
|Texto del mensaje|Error al procesar el mensaje X12 en el puerto de envío {0}. No existen acuerdos de pares de calificador o identificador de destinatario y remitente de {1}, {2}, {3}, \{4\. No existe ninguna entidad con nombre {5}.|  
