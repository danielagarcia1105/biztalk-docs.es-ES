...
ms.locfileid: "24015957"
---
# <a name="create-your-application"></a>Crear la aplicación
Esta sección contiene información para los desarrolladores que desean crear aplicaciones de BizTalk Server y trabajar con el adaptador de BizTalk para TIBCO Rendezvous. Una vez creadas estas aplicaciones, a continuación, puede [Agregar control de excepciones](../core/using-biztalk-server-exception-handling4.md) a la orquestación. 
