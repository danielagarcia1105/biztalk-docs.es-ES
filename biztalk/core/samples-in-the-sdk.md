...
|-----------------|----------|  
|Instalación en una plataforma de 32 bits|[!INCLUDE[btsBiztalkServerPath](../includes/btsbiztalkserverpath-md.md)]\SDK\Samples|  
|Instalación en una plataforma de 64 bits.|[!INCLUDE[btsBizTalkServerPathx64](../includes/btsbiztalkserverpathx64-md.md)]\SDK\Samples|  
  
> [!IMPORTANT]
>  Por cuestión de simplicidad, los ejemplos de este SDK y esta documentación, suponen que va a usar una instalación del programador en un único equipo de BizTalk Server. Si no lleva a cabo la instalación completa de [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], es posible que algunos ejemplos no funcionen correctamente.  
  
> [!NOTE]
>  Todos los elementos de SDK de [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] se proporcionan en inglés y solo son compatibles con las instalaciones en inglés de [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)].  
