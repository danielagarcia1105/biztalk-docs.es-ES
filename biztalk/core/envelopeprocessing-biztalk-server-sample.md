...
|--------------------|--------------------------|  
|Canalización de recepción personalizada|-Utiliza el Desensamblador de archivos sin formato y esquemas de archivo sin formato para traducir los mensajes de pedido de compra de entrada.|  
...
|Esquema de sobre|: Se usa para envolver pedidos individuales con información procedente del encabezado.|  
...
|Canalización de envío personalizada|-Utiliza el ensamblador de XML y una combinación de esquemas de sobre y el cuerpo para traducir los mensajes de instancia en formato XML.|  
...
-   El esquema de sobre XML combina elementos del encabezado y del pedido para generar un único mensaje XML. El esquema de encabezado promociona el campo de origen en el campo SourceParty en la **BTS.bts_system_properties** espacio de nombres; el esquema de sobre promociona el mismo valor, provocando que se degradan en el mensaje saliente.  
...
|EnvelopeProcessingBinding.xml|Se utiliza para la instalación automatizada, como el enlace de puerto.|  
