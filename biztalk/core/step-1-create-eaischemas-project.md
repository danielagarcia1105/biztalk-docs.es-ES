...
-   Antes de comenzar este paso debe completar los pasos descritos en [antes de empezar el Tutorial](../core/before-you-begin-the-tutorial.md).  
...
3.  En el **nuevo proyecto** diálogo cuadro, realice lo siguiente:  
    ...
    |**Nombre**|Tipo de **EAISchemas**.|  
    |**Ubicación**|Tipo de **C:\tutorial\Lessons**.|  
    |**Nombre de solución**|Tipo de **EAISolution**.|  
