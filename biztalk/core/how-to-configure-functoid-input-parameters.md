...
- Edite directamente la lista de parámetros de entrada mediante el **configurar \<Functoid\> Functoid** cuadro de diálogo.  
  ...
  Puede configurar los functoids de secuencias de comandos y el bucle de tabla mediante el **configurar \<Functoid\> Functoid** cuadro de diálogo. Para obtener información sobre cómo configurar los functoids, consulte [cómo configurar el Functoid de Scripting](../core/how-to-configure-the-scripting-functoid.md) y [cómo configurar el bucle de tabla y los Functoids de Extractor de tabla](../core/how-to-configure-the-table-looping-and-table-extractor-functoids.md).  
...
> [!NOTE]
>  Existen algunos functoids, como **fecha**, **tiempo**, **fecha y hora**, y **Nil**, que no necesitan ningún parámetro de entrada.  
...
## <a name="to-open-the-configure-functoid-functoid-dialog-box"></a>Para abrir configurar \<Functoid\> cuadro de diálogo de Functoid  
 Puede abrir el **configurar \<Functoid\> Functoid** cuadro de diálogo en una de las maneras siguientes:  
...
-   Seleccione el functoid y, a continuación, haga clic en el botón de puntos suspensivos (**...** ) en Visual Studio **propiedades** ventana.  
  
-   Seleccione el functoid y presione ENTRAR del teclado.  
  
-   Seleccione el functoid y presione CTRL+M, CTRL+I del teclado. Para obtener una lista de teclas de método abreviado del asignador, vea [métodos abreviados de teclado del asignador de BizTalk](../core/biztalk-mapper-keyboard-shortcuts.md).  
  
### <a name="to-insert-constant-input-parameters"></a>Para insertar parámetros de entrada constantes  
  
1.  En el **configurar \<Functoid\> Functoid** cuadro de diálogo, seleccione el **entradas de Functoid** ficha.  
  
    > [!NOTE]
    >  El **entradas de Functoid** pestaña está activada de forma predeterminada.  
...
1.  En el **configurar \<Functoid\> Functoid** cuadro de diálogo, haga clic en la constante existente entrada de parámetro que desea editar. El valor actual está seleccionado.  
...
2.  Haga clic en el ![mover hacia arriba en la lista](../core/media/move-up-button.gif "Move_up_button") botón para mover el parámetro hacia arriba en la lista de parámetros. Repita según sea necesario hasta que el parámetro de entrada seleccionado se encuentre en la posición deseada. Como alternativa, puede presionar la tecla FLECHA ARRIBA del teclado. Para obtener una lista de teclas de método abreviado del asignador, vea [métodos abreviados de teclado del asignador de BizTalk](../core/biztalk-mapper-keyboard-shortcuts.md).  
    ...
    > [!IMPORTANT]
    >  Puede reorganizar la secuencia de entradas solo desde el **configurar \<Functoid\> Functoid** cuadro de diálogo. Si selecciona la fila superior o inferior, el ![mover hacia arriba en la lista](../core/media/move-up-button.gif "Move_up_button") o ![mover hacia abajo en una lista](../core/media/move-down-button.gif "Move_down_button")se deshabilitarán los botones, respectivamente.  
...
2.  En el **editar** menú, haga clic en **eliminar**.  
    ...
    > [!IMPORTANT]
    >  El vínculo de entrada se elimina silenciosamente. Siempre puede deshacer la eliminación si no está seguro de ella. Para obtener más información acerca de las operaciones de deshacer y rehacer, consulte [cómo deshacer o rehacer operaciones de usuario](../core/how-to-undo-or-redo-user-operations.md).  
...
1.  En el **configurar \<Functoid\> Functoid** cuadro de diálogo, haga clic en existente de parámetro que desea eliminar la entrada.  
...
2.  Haga clic en el ![eliminar la selección](../core/media/delete-button.gif "Delete_button") botón. El parámetro de entrada existente seleccionado se elimina de la lista de parámetros. Haga clic en **Aceptar**.  
    ...
    > [!IMPORTANT]
    >  El parámetro de entrada se elimina silenciosamente. Siempre puede deshacer la eliminación si no está seguro de ella. Para obtener más información acerca de las operaciones de deshacer y rehacer, consulte [cómo deshacer o rehacer operaciones de usuario](../core/how-to-undo-or-redo-user-operations.md).  
...
2.  Tipo de la **etiqueta** y **comentarios**y, a continuación, haga clic en **Aceptar**.  
    ...
    > [!IMPORTANT]
    >  Para obtener más información acerca de cómo la etiqueta y comentar functoids y/o vínculos, consulte [cómo etiquetar un vínculo](../core/how-to-label-a-link.md) y [cómo etiquetar y comentar un Functoid](../core/how-to-label-and-comment-a-functoid.md).  
