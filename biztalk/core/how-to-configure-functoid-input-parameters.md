...
## <a name="to-open-the-configure-functoid-functoid-dialog-box"></a>Para abrir configurar \<Functoid > Functoid cuadro de diálogo  
...
### <a name="to-delete-existing-input-parameters-within-the-configure-functoid-functoid-dialog-box"></a>Para eliminar parámetros de entrada existentes en la configuración \<Functoid > Functoid cuadro de diálogo  
