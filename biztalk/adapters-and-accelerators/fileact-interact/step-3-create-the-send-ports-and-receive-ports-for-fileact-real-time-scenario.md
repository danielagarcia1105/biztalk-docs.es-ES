...
---
# <a name="step-3-create-the-send-ports-and-receive-ports-for-the-fileact-real-time-scenario"></a>Paso 3: Crear los puertos de envío y puertos de recepción para el escenario en tiempo real de FileAct
Antes de comenzar los pasos descritos en esta sección, debe completar [paso 2: Agregar configuración SWIFTNet a la Paramfile para el escenario de en tiempo real de FileAct](../../adapters-and-accelerators/fileact-interact/step-2-add-swiftnet-configuration-to-paramfile-for-fileact-real-time-scenario.md).  
...
-   [Paso 3F: agregar un puerto de envío de archivos para el escenario en tiempo real de FileAct capturar los mensajes de Sw-HandleFileEventRequest](../../adapters-and-accelerators/fileact-interact/step-3f-add-file-send-port-to-get-sw-handlefileeventrequest-messages--fileact.md)