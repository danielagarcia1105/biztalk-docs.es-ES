...
---
# <a name="fileact-adapter-architecture"></a>Arquitectura del adaptador de FileAct
Esta sección contiene información acerca de la arquitectura del adaptador de FileAct.  
