...
---
# <a name="step-3-create-send-and-receive-ports-for-the-interact-real-time-scenario"></a>Paso 3: Crear el envío y puertos de recepción para el escenario en tiempo real de interactuar
Para obtener información acerca de BizTalk Server de envío y puertos de recepción y ubicaciones de recepción, consulte [administrar artefactos](../../core/managing-artifacts.md) en los documentos de servidor BizTalk Server.  
