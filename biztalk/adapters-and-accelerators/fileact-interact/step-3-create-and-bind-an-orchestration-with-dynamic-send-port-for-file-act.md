...
---
# <a name="step-3-create-and-bind-an-orchestration-with-dynamic-send-port--for-the-file-act-store-and-forward-pull-scenario"></a>Paso 3: Crear y enlazar una orquestación con el puerto de envío dinámico para el almacén de archivos de Act y escenario de reenvío (extracción)
Complete los pasos de la [paso 2c: agregar un puerto de envío de FILEACT para el escenario de reenvío (extracción) y el almacenamiento de FileAct](../../adapters-and-accelerators/fileact-interact/step-2c-add-a-fileact-send-port-for-fileact-store-and-forward-pull-scenario.md) antes de comenzar los pasos descritos en esta sección.
