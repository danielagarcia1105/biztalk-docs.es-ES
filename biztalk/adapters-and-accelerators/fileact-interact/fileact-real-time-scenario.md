...
---
# <a name="fileact-real-time-scenario"></a>Escenario en tiempo real de FileAct
Antes de comenzar con este escenario, debe completar [preparando para utilizar el Tutorial](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md).  
