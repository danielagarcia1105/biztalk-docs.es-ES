...
---
# <a name="step-4a-start-the-swiftnet-service-for-the-interact-store-and-forward-pull-scenario"></a>El paso 4A: iniciar el servicio SWIFTNet para el almacén de interacción y el escenario de avance (extracción)
