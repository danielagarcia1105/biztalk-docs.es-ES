...
---
# <a name="step-4-test-the-interact-store-and-forward-pull-end-to-end-scenario"></a>Paso 4: Probar el almacén de interacción y el escenario de-to-End de avance (extracción)
Antes de comenzar los pasos descritos en esta sección, debe completar [paso 3B: enlazar la orquestación con el puerto de envío dinámico para interactuar almacén y escenario de reenvío (extracción)](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-port-for-interact-scenario.md).  
