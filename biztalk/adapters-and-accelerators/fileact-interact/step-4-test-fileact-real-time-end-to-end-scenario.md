...
---
# <a name="step-4-test-fileact-real-time-end-to-end-scenario"></a>Paso 4: Probar el escenario de extremo a extremo en tiempo real de FileAct
Antes de comenzar los pasos descritos en esta sección, debe completar [paso 3F: agregar un puerto de envío de archivo para el escenario de FileAct en tiempo real para capturar los mensajes Sw-HandleFileEventRequest](../../adapters-and-accelerators/fileact-interact/step-3f-add-file-send-port-to-get-sw-handlefileeventrequest-messages--fileact.md).  
