...
ms.locfileid: "22222732"
---
# <a name="fileact-store-and-forward-pull-scenario"></a>Escenario de reenvío (extracción) y almacenamiento de FileAct
Completa [preparando para utilizar el Tutorial](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md) antes de comenzar los pasos descritos en este escenario.
  
## <a name="steps-in-this-section"></a>Pasos de esta sección  
  
-   [Paso 1: Configurar el adaptador de SWIFT para el escenario de avance (extracción) y el almacenamiento de FileAct](../../adapters-and-accelerators/fileact-interact/step-1-configure-the-swift-adapter-for-fileact-store-and-forward-pull-scenario.md)
