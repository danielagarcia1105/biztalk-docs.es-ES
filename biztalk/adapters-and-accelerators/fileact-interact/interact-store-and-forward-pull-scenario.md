...
---
# <a name="interact-store-and-forward-pull-scenario"></a>Interactuar almacén y escenario de reenvío (extracción)
Antes de comenzar los pasos descritos en esta sección, debe completar los pasos descritos en la [preparando para utilizar el Tutorial](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md) sección.  
  
## <a name="in-this-section"></a>En esta sección  
  
-   [Paso 1: Configurar el adaptador de SWIFT para el almacén de interacción y el escenario de avance (extracción)](../../adapters-and-accelerators/fileact-interact/step-1-configure-the-swift-adapter-for-interact-store-and-forward-scenario.md)  
