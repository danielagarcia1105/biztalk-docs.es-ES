...
ms.locfileid: "22223204"
---
# <a name="step3-create-an-orchestration-with--dynamic-send-port-for-the-interact-store-and-forward-pull-scenario"></a>Paso 3: Crear una orquestación con el puerto de envío dinámico para el almacén de interacción y el escenario de reenvío (extracción)
