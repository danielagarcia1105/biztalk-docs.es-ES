...
---
# <a name="connect-to-oracle-e-business-suite-in-visual-studio-using-consume-adapter-service-add-in"></a>Conectarse a Oracle E-Business Suite en Visual Studio mediante el complemento Consume Adapter Service
El [!INCLUDE[consumeadapterservshort](../../includes/consumeadapterservshort-md.md)] se instala al instalar [!INCLUDE[afproductnameshort](../../includes/afproductnameshort-md.md)]. El [!INCLUDE[consumeadapterservshort](../../includes/consumeadapterservshort-md.md)] carga todos los enlaces de WCF-Custom instalados en el equipo. Para conectarse a Oracle E-Business Suite mediante basada en WCF [!INCLUDE[adapteroraclebusinessshort](../../includes/adapteroraclebusinessshort-md.md)] en un proyecto de BizTalk, debe usar el **oracleEBSBinding**.  
...
## <a name="connecting-to-oracle-e-business-suite-using-the-consume-adapter-service-add-in"></a>Conectarse a Oracle E-Business Suite utilizando el consumir el adaptador de complemento de servicio  
