...
---
# <a name="considerations-using-the-oracle-business-suite-adapter-with-sharepoint"></a>Consideraciones al utilizar el adaptador de Oracle-Business Suite con SharePoint
Este tema contiene información sobre los problemas que puede surgir al usar el [!INCLUDE[adapteroracleebusinesslong](../../includes/adapteroracleebusinesslong-md.md)] con Microsoft Office SharePoint Server, junto con las soluciones. Los problemas se dividen en dos categorías:  
...
## <a name="general-issues"></a>Problemas generales  
 Esta sección contiene problemas que no tener ninguna resolución.  
...
##  <a name="Custom_Web_Part"></a>Problemas relacionados con elementos Web personalizados  
 Esta sección contiene problemas que requieren el uso del elemento Web personalizado para una resolución. Para obtener información detallada sobre el uso de un elemento Web personalizado para resolver los problemas que podrían surgir mientras se trabaja con [!INCLUDE[adapteroraclebusinessshort](../../includes/adapteroraclebusinessshort-md.md)] y Microsoft Office SharePoint Server, vea [cómo usar un elemento web personalizado con Oracle E-Business Suite](../../adapters-and-accelerators/adapter-oracle-ebs/how-to-use-a-custom-web-part-with-oracle-e-business-suite.md).  
 ...
 **Resolución**: debe usar un elemento Web personalizado para ello. Para obtener información sobre el uso de un elemento Web personalizado, vea [cómo usar un elemento web personalizado con Oracle E-Business Suite](../../adapters-and-accelerators/adapter-oracle-ebs/how-to-use-a-custom-web-part-with-oracle-e-business-suite.md). En "Paso 1: crear una personalizada elemento Web" de ese tema, puede usar el siguiente ejemplo de código en el paso 5. El ejemplo de código siguiente toma BankCountry y BankKey como los parámetros de entrada y, a continuación, muestra como un único registro de Microsoft Office SharePoint Server.  
 ...
 **Resolución**: usar un elemento Web personalizado para asignar valores a los elementos de la matriz. Para obtener información sobre el uso de un elemento Web personalizado, vea [cómo usar un elemento web personalizado con Oracle E-Business Suite](../../adapters-and-accelerators/adapter-oracle-ebs/how-to-use-a-custom-web-part-with-oracle-e-business-suite.md). Por ejemplo, puede usar el siguiente ejemplo de código en el paso 3 en "problema 1: limitación con la presentación de un único registro de Microsoft Office SharePoint Server en función de varios valores" para asignar valores a los elementos de la matriz.  
 ...
 **Resolución**: usar un elemento Web personalizado para asignar un valor NULL para el parámetro de tipo complejo. Para obtener información sobre el uso de un elemento Web personalizado, vea [cómo usar un elemento web personalizado con Oracle E-Business Suite](../../adapters-and-accelerators/adapter-oracle-ebs/how-to-use-a-custom-web-part-with-oracle-e-business-suite.md).  
