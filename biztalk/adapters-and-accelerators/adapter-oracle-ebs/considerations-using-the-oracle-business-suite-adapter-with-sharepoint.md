...
##  <span data-ttu-id="abef8-132"><a name="Custom_Web_Part"></a>Problemas relacionados con elementos Web personalizados</span><span class="sxs-lookup"><span data-stu-id="abef8-132"><a name="Custom_Web_Part"></a> Issues Involving Custom Web Parts</span></span>  
...
###  <span data-ttu-id="abef8-135"><a name="Issue1"></a>Problema 1: Limitación con la presentación de un único registro de Microsoft Office SharePoint Server en función de varios valores</span><span class="sxs-lookup"><span data-stu-id="abef8-135"><a name="Issue1"></a> Issue 1: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
