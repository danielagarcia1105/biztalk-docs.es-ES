...
> [!IMPORTANT]
>  Si desea configurar un puerto personalizado de WCF para el [!INCLUDE[adapteroraclebusinessshort](../../includes/adapteroraclebusinessshort-md.md)], no es necesario realizar este procedimiento.  
  
### <a name="to-add-the-oracle-e-business-suite-adapter"></a>Para agregar el adaptador de Oracle E-Business Suite  
...
4.  En el **propiedades del adaptador** diálogo cuadro, especifique un nombre para el adaptador y de la **adaptador** lista, seleccione **WCF-OracleEBS**.  
