...
---
# <a name="reuse-sap-adapter-bindings"></a>Reutilizar los enlaces del adaptador SAP
...
Para obtener información acerca de cómo especificar el nombre de usuario y contraseñas, consulte [configurar el inicio de sesión en las credenciales para el sistema SAP](../../adapters-and-accelerators/adapter-sap/configure-the-sign-in-credentials-for-the-sap-system.md).
