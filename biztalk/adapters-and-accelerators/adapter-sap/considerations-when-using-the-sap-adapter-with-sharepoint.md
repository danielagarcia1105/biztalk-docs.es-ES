...
##  <a name="Custom_Web_Part"></a><span data-ttu-id="f8aa4-132">Problemas relacionados con elementos Web personalizados</span><span class="sxs-lookup"><span data-stu-id="f8aa4-132">Issues Involving Custom Web Parts</span></span>  
...
###  <a name="Issue1"></a><span data-ttu-id="f8aa4-135">Problema 1: Limitación con la presentación de un único registro de Microsoft Office SharePoint Server en función de varios valores</span><span class="sxs-lookup"><span data-stu-id="f8aa4-135">Issue 1: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
