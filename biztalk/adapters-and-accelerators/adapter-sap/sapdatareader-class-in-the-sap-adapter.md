...
|**Obtener [métodos]**<sup>*</sup><br /><br /> donde [métodos] es el tipo de datos esperado. Por ejemplo: GetInt32(int)|Obtiene el valor de la columna en función del tipo de datos esperado|  
