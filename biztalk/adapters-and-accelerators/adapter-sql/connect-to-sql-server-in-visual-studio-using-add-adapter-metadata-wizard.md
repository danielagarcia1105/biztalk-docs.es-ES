...
---
# <a name="connect-to-sql-server-in-visual-studio-using-add-adapter-metadata-wizard"></a>Conectarse a SQL Server en Visual Studio mediante metadatos de Asistente para agregar adaptador
...
## <a name="connecting-to-sql-server-using-add-adapter-metadata-wizard"></a>Conectar a SQL Server mediante metadatos de Asistente para agregar adaptador  
