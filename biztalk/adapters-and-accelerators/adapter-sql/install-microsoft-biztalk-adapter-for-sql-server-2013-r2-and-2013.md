...
---
# <a name="install-microsoft-biztalk-adapter-for-sql-server---2013-r2-and-2013"></a>Instalar al adaptador de Microsoft BizTalk para SQL Server - 2013 R2 y 2013
Instalar el [!INCLUDE[adaptersql_md](../../includes/adaptersql-md.md)] incluido con [!INCLUDE[bts2013r2_md](../../includes/bts2013r2-md.md)], o se incluye con [!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] 2013.
...
Instalar el software siguiente en el equipo donde va a usar el [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)] con [!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]. Se recomienda instalar el software en el mismo orden que se muestra aquí.  
...
- **Versiones compatibles de server**: SQL Server 2005, SQL Server 2008 SP1, SQL Server 2008 R2, SQL Server 2012  

- **Admite las versiones de cliente**: Microsoft [!INCLUDE[dotnet45](../../includes/dotnet45-md.md)] agrupaciones de lo archivos DLL de cliente necesaria para conectarse a SQL Server. No es necesario instalar explícitamente cualquier cliente de los archivos DLL en el equipo.  
...
El [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)] puede ejecutar en una instancia de host de 32 bits o 64 bits.
 ...
 Para obtener más información acerca de los escenarios de instalación admitidos para los 32 bits y 64 bits [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)],. 

<a name="BKMK_Install_Adap"></a>   
## <a name="install-the-sql-adapter"></a>Instalar al adaptador de SQL  
 Asegúrese de que tiene los requisitos previos instalados antes de instalar el [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)].  
...
#### <a name="install-scenarios-on-a-32-bit-platform"></a>Escenarios de instalación en una plataforma de 32 bits  
...
#### <a name="install-scenarios-on-a-64-bit-platform"></a>Escenarios de instalación en una plataforma de 64 bits  
...
### <a name="install-the-sql-adapter-in-silent-mode"></a>Instalar al adaptador de SQL en modo silencioso  
 El siguiente procedimiento muestra cómo realizar una instalación silenciosa de [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)] utilizando el `msiexec` comando.  
...
#### <a name="manually-remove-the-bindings"></a>Quitar manualmente los enlaces  
 Lleve a cabo estos pasos *sólo* si se produce un error en el Asistente para instalación quitar los enlaces del adaptador desde el archivo machine.config.  
