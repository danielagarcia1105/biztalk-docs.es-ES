...
---
# <a name="diagnostic-tracing-and-message-logging-for-the-oracle-database-adapter"></a>Seguimiento de diagnóstico y registro de mensajes para el adaptador de base de datos de Oracle
Seguimiento de diagnóstico le ayuda a diagnosticar eficazmente los problemas que pueden surgir al usar los adaptadores. En este tema se proporciona información acerca de los siguientes dos tipos de seguimiento compatible con [!INCLUDE[adapteroracle](../../includes/adapteroracle-md.md)]:  
...
```  
 ...
 Esto guarda los seguimientos WCF en C:\log\WCFTrace.svclog. [Seguimiento de WCF](https://msdn.microsoft.com/library/ms730342.aspx) proporciona más información útil.
  
> [!IMPORTANT]
>  Asegúrese de que mitigar posibles amenazas de seguridad de exponer los datos empresariales confidenciales mediante la habilitación del seguimiento. Para obtener recomendaciones, consulte [procedimientos recomendados para proteger el adaptador de base de datos de Oracle](../../adapters-and-accelerators/adapter-oracle-database/best-practices-to-secure-the-oracle-database-adapter.md)
...
## <a name="viewing-the-traces"></a>Ver los seguimientos  
 Puede usar la herramienta Service Trace Viewer de Windows Communication Foundation (WCF) para ver los seguimientos. Consulte [utilizando Service Trace Viewer para ver seguimientos asociados y solución de problemas](https://msdn.microsoft.com/library/aa751795.aspx).
