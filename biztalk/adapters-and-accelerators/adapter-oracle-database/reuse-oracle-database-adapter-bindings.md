...
---
# <a name="reuse-oracle-database-adapter-bindings"></a>Reutilizar los enlaces del adaptador de la base de datos de Oracle
...
-   La configuración para cada puerto de envío, puerto de recepción, ubicación de recepción y entidad a la que se ha configurado
 ...
 Un archivo de enlace no se genera automáticamente para un ensamblado, aplicación o el grupo de BizTalk. Sin embargo, puede generar un archivo de enlace mediante la exportación de enlaces. A continuación, puede importar el archivo de enlace en una aplicación o un grupo.  
