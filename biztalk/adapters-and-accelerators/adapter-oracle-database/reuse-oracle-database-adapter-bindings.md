...
---
# <a name="reuse-oracle-database-adapter-bindings"></a>Volver a usar los enlaces del adaptador de base de datos de Oracle
...
- La configuración para cada puerto de envío, puerto de recepción, ubicación de recepción y entidad que se ha configurado
  ...
  No se genera automáticamente un archivo de enlace de un ensamblado, aplicación o el grupo de BizTalk. Sin embargo, puede generar un archivo de enlace mediante la exportación de enlaces. A continuación, puede importar el archivo de enlace a una aplicación o grupo.  
...
Para obtener información acerca de cómo especificar el nombre de usuario y contraseñas, consulte [configurar el inicio de sesión en las credenciales para la base de datos de Oracle](../../adapters-and-accelerators/adapter-oracle-database/configure-the-sign-in-credentials-for-the-oracle-database.md).  
