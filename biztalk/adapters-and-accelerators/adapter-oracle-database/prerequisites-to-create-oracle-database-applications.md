...
¿Qué debe hacer antes de desarrollar aplicaciones de BizTalk con el [!INCLUDE[adapteroracle_short](../../includes/adapteroracle-short-md.md)]. También se mencionan algunas herramientas de BizTalk Server que se usan para desarrollar aplicaciones de BizTalk.  
