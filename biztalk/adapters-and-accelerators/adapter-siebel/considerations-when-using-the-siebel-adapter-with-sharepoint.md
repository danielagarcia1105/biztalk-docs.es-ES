...
##  <span data-ttu-id="19aa1-132"><a name="Custom_Web_Part"></a>Problemas relacionados con elementos Web personalizados</span><span class="sxs-lookup"><span data-stu-id="19aa1-132"><a name="Custom_Web_Part"></a> Issues Involving Custom Web Parts</span></span>  
...
###  <span data-ttu-id="19aa1-156"><a name="Issue1"></a>Problema 4: Limitación con la presentación de un único registro de Microsoft Office SharePoint Server en función de varios valores</span><span class="sxs-lookup"><span data-stu-id="19aa1-156"><a name="Issue1"></a> Issue 4: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
