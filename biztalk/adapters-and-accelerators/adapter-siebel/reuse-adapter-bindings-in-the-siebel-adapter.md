...
---
# <a name="reuse-adapter-bindings-in-the-siebel-adapter"></a>Volver a usar los enlaces del adaptador en el adaptador de Siebel
...
Para obtener información acerca de cómo especificar el nombre de usuario y contraseñas, consulte [configurar el inicio de sesión en las credenciales para el Siebel](../../adapters-and-accelerators/adapter-siebel/configure-the-sign-in-credentials-for-the-siebel.md).
