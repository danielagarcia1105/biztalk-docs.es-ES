...
## <a name="connecting-to-a-siebel-system-using-add-adapter-metadata-wizard"></a>Conectarse a un sistema Siebel mediante metadatos de Asistente para agregar adaptador  
 Realice los pasos siguientes para conectarse a un sistema Siebel mediante el [!INCLUDE[addadapterwiz](../../includes/addadapterwiz-md.md)].  
...
1.  Para conectarse mediante la [!INCLUDE[addadapterwiz](../../includes/addadapterwiz-md.md)] en una solución de BizTalk:  
    ...
    5.  En el [!INCLUDE[addadapterwiz](../../includes/addadapterwiz-md.md)], seleccione WCF-Siebel. Seleccione el equipo en el que [!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] está instalado y el nombre de la base de datos de BizTalk.  
