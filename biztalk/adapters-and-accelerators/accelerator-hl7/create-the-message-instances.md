...
> [!NOTE]
>  Al crear estos mensajes en el Bloc de notas, elimine el siguiendo la última línea de retorno de carro.  
...
2.  En el Bloc de notas, copie el texto siguiente:  
...
### <a name="to-create-the-batch-inbatch-out-message-instance-text-file"></a>Para crear el lote o archivo de texto instancia de mensaje de lote  
...
4. En una nueva instancia del Bloc de notas, copie el texto siguiente:  
...
5. Guarde el archivo como **CreateBatchMessage2.txt** en el \< *unidad*:\>\Batching Tutorial\Instances carpeta y, a continuación, cierre el Bloc de notas.  
   ...
   Continúe con [parte 1: fragmentados por lotes entrantes escenario](../../adapters-and-accelerators/accelerator-hl7/part-1-fragmented-inbound-batch-scenario.md).