...
En este paso, creará un puerto para enviar confirmaciones de vuelta al origen del lote.  
 ...
 Crear el puerto con filtros que restringen el puerto de envío de confirmaciones, no los mensajes de datos. Estos filtros especifican un tipo de mensaje de ACK_024_GLO_DEF y un destino de Tutorial_BatchSource.  
...
2.  En el cuadro de diálogo Propiedades de puerto de envío, realice lo siguiente:  
    ...
    |Use|Para|  
    |--------------|----------------|  
    |**Nombre**|Tipo de **Tutorial_2wayAck**.|  
...
3.  En el cuadro de diálogo Propiedades de transporte de MLLP, haga lo siguiente:  
    ...
    |Use|Para|  
    |--------------|----------------|  
    |**Nombre de conexión**|Tipo de **2wayAck**.|  
    |**Host**|Tipo de **localhost**.|  
    |**Puerto**|Tipo de **41002**.|  
    |**Petición respuesta habilitado**|Mantener el campo como **No**.|  
...
6.  En el árbol de consola, haga clic en **filtros**, y, a continuación, realice lo siguiente:  
    ...
    > [!NOTE]
    >  Asegúrese de especificar los siguientes datos tal y como se muestra. Estos datos distingue mayúsculas de minúsculas.  
  
    |Use|Para|  
    |--------------|----------------|  
    |**Propiedad** (primera línea)|Haga clic en el campo **propiedad**, a continuación, seleccione **BTS. MessageType** en la lista desplegable.|  
    ...
    |**Propiedad** (tercera línea)|Haga clic en el campo en la segunda línea en **propiedad**, a continuación, seleccione **BTAHL7Schemas.MSH5_1**.|  
    |**Operador**|Seleccione  **==**  en la lista desplegable.|  
    |**Valor**|Tipo de **Tutorial_BatchSource**.|  
...
9. Haga clic en **ubicaciones de recepción**. Compruebe que el estado de la TwoWayAckReceiveLocation está habilitado. Si no es así, haga clic en **TwoWayAckReceiveLocation**y, a continuación, haga clic en **habilitar**.  
