...
2.  En el cuadro de diálogo Propiedades de puerto de envío, realice lo siguiente:  
    ...
    |Use|Para|  
    |--------------|----------------|  
    |**Nombre**|Tipo de **Tutorial_BatchSource**.|  
...
2.  En el cuadro de diálogo Propiedades de la entidad, haga clic en **puertos de envío** en el árbol de consola. Para **puertos de envío**, seleccione **Tutorial_BatchSource** desde la lista desplegable y, a continuación, haga clic en **Aceptar**.  
