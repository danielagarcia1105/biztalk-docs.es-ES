...
Puede cambiar o quitar Microsoft [!INCLUDE[A4SWIFT_CurrentVersion_FirstRef](../../includes/a4swift-currentversion-firstref-md.md)] desde su equipo mediante la ejecución de la **Asistente para la instalación** o mediante la **el Panel de Control**.  

## <a name="change-or-update-your-a4swift-installation"></a>Cambiar o actualizar la instalación de A4SWIFT  
  
1.  Abra la **el Panel de Control**y, a continuación, haga doble clic en **desinstalar un programa**.  
...
4.  En el **instalación personalizada** página, seleccione los componentes que desea cambiar o quitar y, a continuación, seleccione **siguiente**.  
