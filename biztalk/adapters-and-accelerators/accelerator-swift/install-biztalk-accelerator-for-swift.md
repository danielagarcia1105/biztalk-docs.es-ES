...
- Microsoft [!INCLUDE[A4SWIFT_CurrentVersion_abbrev](../../includes/a4swift-currentversion-abbrev-md.md)] archivo Léame, ubicado en el Acelerador de BizTalk para SWIFT \Documentation carpeta \Program Files\Microsoft.  
  -->
...
* El programa de instalación de A4SWIFT siempre se ejecuta con la `/InstallPlatform` argumento. Como resultado, el programa de instalación siempre instala msvcr71.dll, mfc71u.dll, msvcp71.dll y atl71.dll, que son necesarios para Visual Studio. El programa de instalación instala estos archivos DLL en el `%WINDIR%\System32` carpeta, si los archivos DLL se han instalado anteriormente o no.
...
6. Revise el **resumen** página. Para realizar cambios, seleccione **volver**.
    ...
    Para habilitar el inicio de sesión automático después de reiniciar el sistema, seleccione **Establecer** y especifique la cuenta de inicio de sesión. Esta opción solo está habilitada durante la instalación. Cuando finalice la instalación, esta configuración se deshabilita.

    Seleccione **Instalar**.

7. Seleccione **finalizar** cuando haya terminado. Se genera un archivo de registro del programa de instalación en una carpeta temporal, similar a: `C:\Users\username\AppData\Local\Setup(111016 xxxxxx).log`.
...
6. Seleccione los componentes y, a continuación, seleccione **siguiente**:
   ...
   |          Conciliación y reparación de mensajes           |    Instale las canalizaciones, orquestaciones y esquemas en tiempo de ejecución. Crea la base de datos de A4SWIFT en SQL Server para mensajería, reparación y conciliación.     |
   | Componentes Web de reparación de mensajes y nuevo envío | Instala el componente de reparación de mensajes y nuevo envío que crean servicios web para la validación, seguridad basada en certificados, historial y búsqueda BIC. |
   |            Kit de desarrollo de software (SDK)            |                                    Incluye proyectos de código, kits de herramientas y starter de código de ejemplo para Visual Studio.                                    |
   ...
   |                       Tutorial                       |                                Iincludes instrucciones y ejemplos para desarrollar una solución de SWIFT de BizTalk Server.                                 |
...
7. Revise el **resumen** página. Para realizar cambios, seleccione **volver**.

    Seleccione **Instalar**.

8. Seleccione **finalizar** cuando haya terminado. Se genera un archivo de registro del programa de instalación en una carpeta temporal, similar a: `C:\Users\username\AppData\Local\Setup(111016 xxxxxx).log`.
