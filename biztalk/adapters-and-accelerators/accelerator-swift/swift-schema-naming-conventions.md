...
-   Si hay una selección de varios formatos para un campo, la etiqueta del nodo es  **\< *elección*\>**, y, a continuación, cada opción es un campo de número (por ejemplo, **fecha _A_98A** y **DateTime_A_98C**).  
