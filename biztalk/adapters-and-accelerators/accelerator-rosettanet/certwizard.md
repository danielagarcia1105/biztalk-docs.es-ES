...
Use la utilidad CertWizard para importar un certificado desde un archivo .pfx o .cer en un almacén privado o público para su uso con Microsoft® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)].  
...
|**Identidad de usuario**|Identidad de servicio que utilizan uno o varios host de BizTalk. Especifique una cuenta de usuario si no desea especificar el host pero desea importar un certificado en una cuenta de usuario. **Nota:** si no se agrega el **Useridentity** cambia, las importaciones de utilidad y establecer el certificado para todos los usuarios. **Nota:** si agrega el **Useridentity** cambiar, pero no especifica un valor, WMI genera automáticamente la identidad del usuario.|  
