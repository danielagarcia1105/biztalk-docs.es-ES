...
|`True`|`True`|`True`|Sí|  
 ...
 \*[!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] no admite esta combinación porque requiere que las señales de firmarse y acciones no se firma.  
