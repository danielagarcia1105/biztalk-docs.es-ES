...
6.  Mover a \< *unidad*\>\Program Files (x86) \Microsoft BizTalk \<versión\> Acelerador para RosettaNet\SDK\SchemaValidator, seleccione  **SchemaValidator.sln**y, a continuación, haga clic en **abiertos**.  
...
14. En el nodo raíz de la instancia de mensaje, agregue un espacio de nombres XML del esquema que se validarán ante.  
    ...
    > [!NOTE]
    >  Para obtener un ejemplo de un esquema listo para ser validado por la utilidad SchemaValidator, vea Sample3A4.xml en \< *unidad*\>\Program Files (x86) \Microsoft BizTalk \<versión\> Acelerador para RosettaNet\SDK\SchemaValidator.  
