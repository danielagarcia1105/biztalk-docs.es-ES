...
## <a name="see-also"></a><span data-ttu-id="78457-107">Vea también</span><span class="sxs-lookup"><span data-stu-id="78457-107">See Also</span></span>  
 [<span data-ttu-id="78457-108">Configuración del trasvase de registros de BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="78457-108">Configuring BizTalk Server Log Shipping</span></span>](../technical-guides/configuring-biztalk-server-log-shipping.md)