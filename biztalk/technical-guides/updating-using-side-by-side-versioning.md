...
-   [Cómo actualizar un mapa con control de versiones en paralelo](../technical-guides/how-to-update-a-map-using-side-by-side-versioning.md)  
...
-   [Actualizar un esquema mediante el control de versiones en paralelo](../technical-guides/updating-a-schema-using-side-by-side-versioning.md)