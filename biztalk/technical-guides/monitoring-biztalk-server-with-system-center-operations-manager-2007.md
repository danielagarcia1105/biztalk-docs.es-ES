...
-   [El módulo de administración de supervisión de BizTalk Server 2010](ttp://go.microsoft.com/fwlink/?LinkId=210666) (ttp://go.microsoft.com/fwlink/?LinkId=210666).  
  
 Esta sección de la Guía de operaciones incluye información general, prácticas recomendadas, listas de comprobación y procedimientos que puede usar para ayudar en la implementación de una estrategia de supervisión basada en Operations Manager.  
