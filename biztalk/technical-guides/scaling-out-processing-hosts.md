...
---
# <a name="scaling-out-processing-hosts"></a>Ajuste de escala en Hosts de procesamiento
Para obtener información acerca de cómo ampliar los hosts de procesamiento, vea [Hosts de procesamiento de Scaled-Out](http://go.microsoft.com/fwlink/?LinkId=151285) (http://go.microsoft.com/fwlink/?LinkId=151285).  
