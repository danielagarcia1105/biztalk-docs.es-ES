...
-   Implementar la **DataFormatTransformation** itinerario.  
...
6.  Haga clic en **DataFormatTransformationReceive.Pipeline**, seleccione **agregar**y, a continuación, haga clic en **nuevo elemento**.  
