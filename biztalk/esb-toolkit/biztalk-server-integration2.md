 ...
 **Instalar el componente de AmberPoint en una canalización de envío**  
  
 Además, AmberPoint incluye cuatro predefinidas canalizaciones que se pueden enlazar directamente a existente ubicaciones de recepción y mediante la consola de administración de BizTalk de puertos de envío. La figura 2 muestra el enlace de una canalización de recepción a un adaptador.  
  
 ![Enlace de AmberPoint](../esb-toolkit/media/ch9-bindingamberpoint.jpg "Ch9-BindingAmberPoint")  
